...
if  not (rst.EOF or rst.BOF) then
	...
	msg="<table border=3 width='100%' bgcolor=666666 cellpadding='3' cellspacing='1' align=center><tr bgcolor=00FF00 align=center><td>时间</td><td>死者</td><td>凶手</td><td>死因</td></TR>"
	for j=1 to rst.Pagesize
		if rst.EOF or rst.BOF then
			exit for
		else	
			msg=msg&"<tr bgcolor=cccc99><td>"&rst("时间")&"</td><td>"&rst("死者")&"</td><td align=right>"&rst("凶手")&"</td><td>"&rst("死因")&"</td></tr>"
			rst.MoveNext
		end if
	next
...
<p align=center><font color="#CC0000" size="4" face="幼圆"><b><%=Application("Ba_jxqy_systemname")%>英烈堂</b></font></p>
<div align=center><%=msg%></div>
<p align=center><a href="#" onclick=javascript:window.close(); onmouseover="window.status='关闭';return true;" onmouseout="window.status='';return true;">关闭</a></p>
</body>