...
if  not (rst.EOF or rst.BOF) then
	...
	msg="<table width='95%' border=1 bordercolorlight=000000 cellspacing=0 cellpadding=2 bordercolordark=FFFFFF align='center'><tr bgcolor=ffFF00 align=center><td width=40>类型</td><td width=140>名称</td><td>参考价格</td><td width=36>更改</td></TR>"
...
<table width=100% border=1 bordercolorlight=000000 cellspacing=0 cellpadding=2 bordercolordark=FFFFFF bgcolor=FFB442>
  <tr align=center> 
    ...
    <td bgcolor=#FFFF00><A href="chgprice.asp" onmouseover="window.strtus='变更已寄售物品的价格';return true;" onmouseout="window.status='';return true">改价</a></td>
</tr></table>
