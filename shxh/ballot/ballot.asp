...
if rst.EOF or rst.BOF then
	msg="<tr><td>目前没有活动的投票箱</td></tr><tr><td align=center><input type=button value=' 返 回 ' onclick=javascript:location.href='../myhome/myhome.asp'></td></tr>"
else
	rst.PageSize=1
	...
	if rst.EOF or rst.BOF then
		msg="<tr><td>无效的投票箱</td></tr><tr><td align=center><input type=button value=' 返 回 ' onclick=javascript:location.href='../myhome/myhome.asp' ></td></tr>"&msgadd
	else
		msg="<form name=form1 action=ballotnow.asp method=post><tr><td align=center bgcolor=ffff00>"&title&"</td></tr><tr><td>"&explain&"</td></tr><tr><td>投票截止时间："&deadline&"</td></tr><tr><td>参加投票条件："&condition&"</td><input type=hidden name=pid value="&pid&"></tr>"
		do while not rst.EOF
			...
			rst.MoveNext
		loop
		msg=msg&"<tr align=center><td> <input type=submit value=' 投 票 '  id=submit1 name=submit1> <input type=button onclick=javascript:location.href='showballot.asp?pid="&pid&"'; value='查看投票结果' > <input type=button value=' 返 回 ' onclick=javascript:location.href='../myhome/myhome.asp' ></td></tr></td></tr>"&msgadd
	end if
end if
rst.Close 
set rst=nothing
...
<p align=center><font color=0000ff size=6 face='隶书'>投票系统</font></p>
