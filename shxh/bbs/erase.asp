...
rst.Open "select 父贴 from bbs where set删除=True and 论坛="&bid&" and id="&id,conn
if rst.EOF or rst.BOF then Response.Redirect "../error.asp?id=238"
fid=rst("父贴")
rst.Close
set rst=nothing
conn.execute "delete from bbs where id="&id&" and 论坛="&bid
if fid=0 then
	conn.execute "delete from bbs where 父贴="&id&" and 论坛="&bid
end if	
conn.close
set conn=nothing
%>
