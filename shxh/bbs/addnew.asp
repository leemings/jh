...
conn.execute "insert into bbs(论坛,父贴,标题,内容,点击,回复,作者,写贴时间,回复作者,回复时间,IP,编辑,精华,删除) values("&bid&",0,'"&title&"','"&content&"',0,0,'"&username&"',"&nowtimetype&",'--',"&nowtimetype&",'"&ip&"',False,False,False)"
