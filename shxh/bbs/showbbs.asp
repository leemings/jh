...
rst.Close
rst.Open "select tu.门派,tu.等级,tu.签名档,tu.电子邮箱,tb.id,tb.论坛,tb.父贴,tb.标题,tb.内容,tb.点击,tb.回复,tb.作者,tb.写贴时间,tb.回复作者,tb.回复时间,tb.ip,tb.编辑,tb.精华,tb.删除 from bbs tb inner join 用户 tu on tu.姓名=tb.作者 where tb.删除=false and tb.id="&fid,conn
