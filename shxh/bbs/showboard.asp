...
rst.Close
msg=msg&"<table border=0 bgcolor='"&Ba_bgcolor&"' background='"&Ba_bgimage&"' width='100%'><tr><td><input type=button onclick="&chr(34)&"javascript:location.replace('addnewbbs.asp?bid="&bid&"');"&chr(34)&"  value=' 发 表 '></td><td><font color=00ff00>"&username&"</font>欢迎您的光临</td><td align=right><a href='today.asp?bid="&bid&"' onmouseover="&chr(34)&"window.status='查看今日新贴';return true;"&chr(34)&" onmouseout="&chr(34)&"window.status='';return true;"&chr(34)&" title="&chr(34)&"查看今日新贴"&chr(34)&">今日新贴</a>>><a href='showessence.asp?bid="&bid&"' onmouseover="&chr(34)&"window.status='查看精华贴';return true;"&chr(34)&" onmouseout="&chr(34)&"window.status='';return true;"&chr(34)&" title="&chr(34)&"查看精华贴"&chr(34)&">精华贴</a></td></tr></table><table border=1 width=90% align=center bgcolor=cccccc><tr bgcolor=fffe48 align=center><td>&nbsp;</td><td>&nbsp;</td><td>文章标题</td><td>新窗口</td><td>作者</td><td>字[回]</td><td>最后回复</td><td>最后更新时间</td><td>点击</td></tr>"
rst.Open "select * from bbs where 论坛="&bid&" and 父贴=0 and 删除=false order by 回复时间 desc",conn,1,3
...
for i=1 to rst.PageSize
	...
	elseif len(rst("标题"))<15 and datediff("d",rst("回复时间"),nowtime)>=1 then 
...
msg=msg&"</table><form method=post action='showboard.asp?bid="&bid&"'><table width=100% bgcolor=cccccc><tr align=center>"
if activepage>1 then
	msg=msg&"<td><a href='showboard.asp?bid="&bid&"&activepage=1' onmouseover="&chr(34)&"window.status='第一页';return true;"&chr(34)&" onmouseout="&chr(34)&"window.status='';return true;"&chr(34)&">第一页</a></td><td><a href='showboard.asp?bid="&bid&"&activepage="&activepage-1&"' onmouseover="&chr(34)&"window.status='前一页';return true;"&chr(34)&" onmouseout="&chr(34)&"window.status='';return true;"&chr(34)&">前一页</a></td>"
else
	msg=msg&"<td>第一页</td><td>前一页</td>"
end if
if activepage<rst.PageCount then
	msg=msg&"<td><a href='showboard.asp?bid="&bid&"&activepage="&activepage+1&"' onmouseover="&chr(34)&"window.status='下一页';return true;"&chr(34)&" onmouseout="&chr(34)&"window.status='';return true;"&chr(34)&">下一页</a></td><td><a href='showboard.asp?bid="&bid&"&activepage="&rst.PageCount&"' onmouseover="&chr(34)&"window.status='最后一页';return true;"&chr(34)&" onmouseout="&chr(34)&"window.status='';return true;"&chr(34)&">最后一页</a></td>"
else
