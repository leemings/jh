...
if not (sendto="大家" or sendto="武术家" or sendto="魔法师"  or sendto=""&corp&"" or sendto="爱情鸟" or sendto="逍遥山庄" or sendto="叛逆魔族" or sendto="酷龍山庄" or sendto="紫樱岛" or sendto="黑色世界" or sendto="桃花岛" or sendto="六扇门" or sendto="洪兴社团" or instr(onlinename,";"&sendto&";")<>0) then
	Response.Write "<script Language=Javascript>alert('"&sendto&"不在聊天室中，不能对其发言。');parent.resfrm.location.href='onlinelist.asp';</script>"
	Response.end
end if
if instr(msg,"C")<>0 or instr(msg,"n")<>0 or instr(msg,"N")<>0  or instr(msg,"狗")<>0  or instr(msg,"逼")<>0 or instr(msg,"B")<>0 or instr(msg,"奶")<>0 or instr(msg,"爷")<>0 or instr(msg,"爸")<>0 or instr(msg,"儿")<>0 or instr(msg,"娘")<>0 or instr(msg,"操")<>0 or instr(msg,"靠")<>0 or instr(msg,"妈")<>0 or instr(msg,"孙")<>0 or instr(msg,"MA")<>0 then
