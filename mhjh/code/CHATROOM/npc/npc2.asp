...
conn.execute "insert into 英烈堂(时间,死者,凶手,死因) values(now(),'"&username&"','吝啬','体力不足累死')"
	...
	conn.execute "update 用户 set 攻击=攻击+"& Application("yx8_mhjh_klt2") *300&" where 姓名='" & st & "'"
	kl="<font color=#0000FF>"&st&"</font>一招打死了怪物，获取怪物身上的攻击"&Application("yx8_mhjh_klt2")*300&"点！"
	Application.Lock
	Application("yx8_mhjh_klt2")=0
	Application.UnLock
	rs.close
