...
conn.execute "insert into 英烈堂(时间,死者,凶手,死因) values(now(),'"&username&"','吝啬','体力不足累死')"
	...
	conn.execute "update 用户 set 防御=防御+"& Application("yx8_mhjh_klt&r") *200&" where 姓名='" & st & "'"
	kl="<font color=#0000FF>"&st&"</font>成功赶走了舞男,聊天室清净了许多,官府奖励防御"&Application("yx8_mhjh_klt&r")*200&"点！"
	Application.Lock
	Application("yx8_mhjh_klt&r")=0
	Application.UnLock
	rs.close
