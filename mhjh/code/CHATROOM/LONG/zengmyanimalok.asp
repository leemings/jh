...
msg="<font color=FF0000>【消息】</font>["&nickname&"]将自己的神龙["&animalname&"]送给了朋友["&towho&"]！"
call chat(says)
rs.Close
set rs=nothing
connb.Close
...
Response.Write "<script language=JavaScript>{alert('神龙赠送成功！！');location.href='myanimal.asp';}</script>"
end if
%>
