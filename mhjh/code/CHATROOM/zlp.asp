...
conn.execute "insert into 英烈堂(时间,死者,凶手,死因) values(now(),'"&username&"','吝啬','体力不足累死')"
	...
	conn.execute "update 用户 set 银两=银两+"& Application("yx8_mhjh_klt") *80000&",精力=精力+"&Application("yx8_mhjh_klt")*1000&" where 姓名='" & st & "'"
	kl="<font color=0000FF>"&st&"</font>动作迅速，成功抢得武术家掉下的白银<img src=data/251.gif>"&Application("yx8_mhjh_klt")*80000&"两，精力"&Application("yx8_mhjh_klt")*1000&"点！"
	Application.Lock
	Application("yx8_mhjh_klt")=0
	Application.UnLock
	rs.close
