...
'if tempjs<>jstl1 then
	...
	'response.end
'end if
conn.execute "update 用户 set 体力=体力-"&Application("yx8_mhjh_klt1")&" where 姓名='"&st&"'"
...
conn.execute "insert into 英烈堂(时间,死者,凶手,死因) values(now(),'"&username&"','吝啬','体力不足累死')"
	...
	conn.execute "update 用户 set 道德=道德+"& Application("yx8_mhjh_klt1") *2000&",资质=资质+"&Application("yx8_mhjh_klt")*1000&" where 姓名='" & st & "'"
	kl="<font color=0000FF>"&st&"</font>动作迅速，成功抢得武术家掉下的道德<img src=IMAGE/IMAGE/wg8.gif>"&Application("yx8_mhjh_klt1")*2000&"点，资质"&Application("yx8_mhjh_klt1")*1000&"点！"
	Application.Lock
	Application("yx8_mhjh_klt1")=0
	Application.UnLock
	rs.close
