...
conn.Close
set conn=nothing
Response.Write "<head><link rel='stylesheet' href='../style.css'></head><body oncontextmenu=self.event.returnValue=false  background='../chatroom/bg1.gif'><table width='80%' border=3  bgcolor=ffffff align=center><tr bgcolor=ffffff align=center><td>有效号码</td><td>落注</td></tr>"&msg&"<tr><td>共下注</td><td align=right>"&money&"</td></tr></table><p align=center><a href='#' onclick='javascript:history.back();'>返回</a></p><p align=center>你已经购买了福利奖券，等明天开奖吧，谢谢大善人！</p></body>"
%>
