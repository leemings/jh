...
<tr>
<td width="552" align="center"><div align="center"><b><font size="3">张老道</font></b> <font color="#CC0033" size="3">
...
response.write "<input type=submit value=开始><br><br><br><br>"
response.write "<font color=black>黑白棋规则：</font><br>"
response.write "<font color=black>1.张真人先走。</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>"
response.write "<font color=black>2.有叉的位置你可以落子。</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>"
response.write "<font color=black>3.在你落子和你其他的子间的黑子将变成你的子。</font><br>"
response.write "<font color=black>4.结束后谁子多谁赢。</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
case 1
response.write "<input type=hidden name=sel value=1>"
...
'Added by Alex98
IF com > human THEN
response.write " 张老道 " & (com) & " 子，你 " & (human) & " 子。"
response.write "<br>"
...
response.write " 张老道 " & (com) & " 子，你 " & (human) & " 子。"
response.write "<br>"
response.write "<font color=black>张老道：为什么会这样，我怎么会输？没办法，你继续闯关吧。</font><BR>"
response.write "<A HREF=""go2.asp""><font color=red>按这里闯下一关吧。</font></a><BR>"
Session("usepro")="1"
end if
END IF
end select
