...
next	
msg="<head><link rel='stylesheet' href='../../chatroom/css.css'></head><body oncontextmenu=self.event.returnValue=false topmargin=0 background='../../chatroom/bg1.gif'><p align=center>管理</p><hr><table width=80% border=3 align=center><tr bgcolor=FFFF00><td width='35%'>属性</td><td>新值</td></tr>"
%>
<!--#include file="data.asp"--><%
Set rst=Server.CreateObject("ADODB.RecordSet")
sqlstr="SELECT * FROM 歌曲 where id="&schid&""
