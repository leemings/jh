...
<body onload="javascript:document.forms[0].username.focus();" bgcolor="FFE4CA" background="/images/bg.gif">
<div align=center> 
  <form action="login.asp" method=post onsubmit='return(check());' name=form1>
    <table width="609">
      ...
      <tr>
       ...
       <tr ><td width="595" align="center" colspan="2">&nbsp;<input onClick="javascript:window.open('gr/regstep1.asp','register','left=200,top=100,width=700,height=500,status=no,toolbars=no,menubars=no,scrollbars=no,resize=no')" title=注册帐号 type=button value="注  册" name="button"> 
          <input onClick="javascript:window.open('gr/relive.asp','relive',' width=300,height=210,left=200,top=100,status=no,toolbars=no,menubars=no,scrollbars=no,resize=no')" title=帐号复活 type=button value="复  活" name="button">   
		  <input onClick="javascript:window.open('gr/help.asp','readme',' width=500,height=300,left=200,top=100,status=no,toolbars=yes,menubars=yes,scrollbars=yes,resize=no')" title=自 救 type=button value="自 救" name="button">
		  <!--
          <input onClick="javascript:window.open('gr/suicide.asp','suicide',' width=300,height=350,left=200,top=100,status=no,toolbars=no,menubars=no,scrollbars=no,resize=no')" title=自 杀 type=button value="自  杀" name="button">     
      ...
      <tr>  
        <td height="29">
			<div class="text" style=" text-align:center;">
			  ...
			  <%=Application("yx8_mhjh_admin")%>
			  </font>开放时间：<font color="#993300">   
			  <%=Application("yx8_mhjh_seriesnumber")%></font> 
			  访问统计：<font color="#993300">  
			  <%=Application("yx8_mhjh_visitor")%>
