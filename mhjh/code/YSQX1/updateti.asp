...
if not(usergrade=120 and usercorp="官府") then Response.Redirect "../error.asp?id=046"
...
'next	
msg="<head><link rel='stylesheet' href='../chatroom/css.css'></head><body oncontextmenu=self.event.returnValue=false topmargin=0 background=../chatroom/bg1.gif bgcolor='"&bgcolor&"'><p align=center>答题</p><hr>"
