...
<TD class=head-l width=660>您当前位置：<a href="../welcome.asp"><font color="#FFFFFF">爱情江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">爱情大酒店</font></a>-&gt;比翼双飞宴会</TD>
...
sql="SELECT * FROM 宴会列表 where  宴会名='比翼双飞'"
