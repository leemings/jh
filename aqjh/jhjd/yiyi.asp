...
<TD class=head-l width=660>您当前位置：<a href="../welcome.asp"><font color="#FFFFFF">快乐江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">快乐大酒店</font></a><font color="#FFFFFF">-&gt;</font>一心一意宴会</TD>
...
<tr>
<td><a href=yiyi.asp
target=_self><img border=0 height=26
...
<tr>
<td><a href=ssss.asp
target=_self><img border=0 height=19
src="jd/index_left3.gif" width=149></a></td>
</tr>
<tr>
<td><a href="smsm.asp"
target=_self><img border=0 height=21
...
<tr>
<td><a href=lqlq.asp
target=_self><img border=0 height=22
...
<p align=center class="p9"><font color="#FF0000"><img src="jd/ysys.gif" width="150" height="25"></font></p>
<tr bgcolor=#74E76D bordercolor="#000000">
<td height="15" bgcolor="#66FF66" bordercolor="#FF6600" width="20%">
<div align="center"><font size="2" color="#FF0000">宴请者</font></div>
</td>
<td height="15" bgcolor="#66FF66" bordercolor="#FF6600" width="30%"><font size="2" color="#FF0000">剩余座位</font></td>
<td height="15" width="40%" bgcolor="#66FF66" bordercolor="#FF6600">
...
rs.close
sql="SELECT * FROM 宴会列表 where  宴会名='一心一意'"
Set Rs=connt.Execute(sql)
do while not rs.bof and not rs.eof
%>
<tr bgcolor=#DEAD63>
<td width="20%" bgcolor="#FFFFFF" class="calen-curr"><font size="2">
<center>
<%=rs("拥有者")%>
</center>
</font> <font size="2"></font>
<td width="30%" bgcolor="#FFFFFF" class="calen-curr"><font size="2"><%=rs("数量")%>个<%=rs("门派")%>酒席</font>
<td width="40%" bgcolor="#FFFFFF" class="calen-curr"><font size="2"><%=rs("时间")%>
</font></td>
<td width="10%" bgcolor="#FFFFFF" class="calen-curr"><font size="2">
<center>
<font size="2">
<%if aqjh_name=rs("拥有者") or mypai=rs("门派") then %>
<a href=ruxi2.asp?id=<%=rs("id")%>><span class="calen-curr">入席</span></a>
<%end if%>
</font>
</center>
</font></td>
