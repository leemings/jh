...
<TD class=head-l width=660>您当前位置：<a href="../welcome.asp"><font color="#FFFFFF">爱情江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">爱情大酒店</font></a>-&gt;五彩缤纷宴会</TD>
...
<p align=center class="p9"><font color="#FF0000"><img src="jd/wcbf.gif" width="150" height="25"></font></p>
...
<!--#include file="dadata.asp"--> <%
sql="SELECT * FROM 宴会列表 where  宴会名='五彩缤纷'"
