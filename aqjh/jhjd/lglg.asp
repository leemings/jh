...
<TD class=head-l width=660>您当前位置：<a href="../welcome.asp"><font color="#FFFFFF">快乐江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">快乐大酒店</font></a>-&gt;流光飞舞宴会</TD>
...
<!--#include file="dadata.asp"--> <%
sql="SELECT * FROM 宴会列表 where  宴会名='流光飞舞'"
