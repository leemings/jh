...
<TD class=head-l width=660>您当前位置：<a href="../welcome.asp"><font color="#FFFFFF">快乐江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">快乐大酒店</font></a>-&gt;郎情妾意宴会</TD>
...
<p align=center class="p9"><font color="#FF0000"><img src="jd/lqqy.gif" width="150" height="25"></font></p>
...
<!--#include file="dadata.asp"--> <%
sql="SELECT * FROM 宴会列表 where  宴会名='郎情妾意'"
