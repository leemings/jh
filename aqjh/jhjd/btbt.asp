...
<TD class=head-l width=660>您当前位置：<a href="../welcome.asp"><font color="#FFFFFF">爱情江湖</font></a>-&gt;<a href="jd.asp"><font color="#FFFFFF">爱情大酒店</font></a>-&gt;白头偕老宴会</TD>
...
<p align=center class="p9"><font color="#FF0000"><img src="jd/btxl.gif" width="150" height="25"></font></p>
...
<td height="15" bgcolor="#66FF66" bordercolor="#FF6600" width="20%"><font size="2" color="#FF0000">剩余座位</font></td>
...
<!--#include file="dadata.asp"--> <%
sql="SELECT * FROM 宴会列表 where  宴会名='白头偕老'"
...
<td width="20%" bgcolor="#FFFFFF" class="calen-curr"><font size="2"><%=rs("数量")%>个</font>
