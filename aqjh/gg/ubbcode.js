...
document.addmess.placard.value+=NewCode;
document.addmess.placard.focus();
return;
}
...
function AddText(text) {
	if (document.addmess.placard.createTextRange && document.addmess.placard.caretPos) {      
		var caretPos = document.addmess.placard.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else document.addmess.placard.value += text;
	document.addmess.placard.focus(caretPos);
}
function inputs(str)
{
AddText(str);
...
document.addmess.placard.value+=ToAdd;
document.addmess.placard.focus();
}
function Cimage() {
var FoundErrors = '';
...
function paste(text) {
	if (opener.document.addmess.placard.createTextRange && opener.document.addmess.placard.caretPos) {      
		var caretPos = opener.document.addmess.placard.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else opener.document.addmess.placard.value += text;
	opener.document.addmess.placard.focus(caretPos);
}
...
document.addmess.placard.value=fontbegin+document.addmess.placard.value+fontend;
document.addmess.placard.focus();
}
}
...
if (ie){
function ctlent(eventobject){if(event.ctrlKey && window.event.keyCode==13){this.document.addmess.submit();}}
}
function DoTitle(addTitle) { 
var revisedTitle; 
var currentTitle = document.addmess.subject.value; 
revisedTitle = currentTitle+addTitle; 
document.addmess.subject.value=revisedTitle; 
document.addmess.subject.focus(); 
return; }

function insertsmilie(smilieface){

	document.addmess.placard.value+=smilieface;
}