...
conn.execute "update 用户 set zhu='"&ghuasj&"',会员金卡=会员金卡+"&huajb&",银两=银两+10000000 where 姓名='" & name &"'"
attack="<font color=#cc66ff><b>【猪场宰杀】</b><bgsound src=images/1.wav loop=2><font color=green>俗话说人怕出名猪怕壮,<font color=red>" & name & "</font>家的小猪猪长大了,看着可爱的猪猪,<font color=red>" & name & "</font>可真有点下不了手,不过想到白花花的银子......<font color=red>" & name & "</font>闭上眼睛手起到落......拿着猪肉到市场上卖得 <font color=red>银两1000万、会员金卡"&huajb&"个</font>,没想到养猪还真能致富！</font>"
Response.Write "<script language=JavaScript>{parent.gg();alert('提示：您宰了您辛苦养大的 ["&huaname&"] 1只，银两1000万、会员金卡"&huajb&"个!');}</script>"
fhuasj=split(rs("zhu"),"|")
seedsm=fhuasj(0)
says=attack 
says=replace(says,"'","\'")
