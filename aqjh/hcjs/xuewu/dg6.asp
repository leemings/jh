...
conn.execute "update 用户 set 体力=体力-2000,内力=内力-700,武功=武功+300,攻击=攻击+5,防御=防御+200,操作时间=now() where 姓名='"&aqjh_name&"'"
	rs.close
	set rs=nothing
	conn.close
	set conn=nothing

message="" & my & "辛辛苦苦学了一天，你武功+300攻击+5防御+200！消耗体力2000内力700！"
says="<font color=red>【江湖武馆】</font><font color=green>["&aqjh_name&"]辛辛苦苦学了一天[葵花宝典]，武功+300攻击+5,防御+200,消耗体力2000内力700</font>"
act="消息"
towhoway=0
towho="大家"
addwordcolor="660099"
