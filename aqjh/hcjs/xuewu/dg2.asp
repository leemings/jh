...
conn.execute "update 用户 set 体力=体力-300,内力=内力-350,武功=武功+60,攻击=攻击+10,防御=防御+2,操作时间=now() where 姓名='"&aqjh_name&"'"
	rs.close
	set rs=nothing
	conn.close
	set conn=nothing
message="" & my & "辛辛苦苦学了一天，你武功+60攻击+10防御+2！消耗体力300内力350！"
says="<font color=red>【江湖武馆】</font><font color=green>["&aqjh_name&"]辛辛苦苦学了一天[降龙十八抓]，武功+60攻击+10,防御+2,消耗体力300内力350</font>"
act="消息"
towhoway=0
towho="大家"
addwordcolor="660099"
