...
set conn=nothing
%>
<HTML><HEAD><TITLE><%=Application("aqjh_chatroomname")%>--交通工具旧车市场</TITLE>
<META content="text/html; charset=gb2312" http-equiv=Content-Type>
<BODY bgColor=#85C2E0 text=#ffffff topMargin=5>
<DIV align=center>
<p align="center">[ <font color="#FF3300" size=4><%=Application("aqjh_chatroomname")%>--交通工具旧车市场</font> ]</p> 
...
<DIV align=center> 
<br><br> 
<font color="#ff00ff" >『快乐江湖』</font></div> 
</body> 
</html> 