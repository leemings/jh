...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="10"><%if lx="花园洋房" then%><img src="image/hy-01.jpg"><%end if%><%if lx="豪华别墅" then%><img src="image/hy-02.jpg"><%end if%> </td>                 
<td height="13" width="159" bgcolor="#C4DEFF">
 <p align="center"><a href="zhongzhi.asp"><font color="#000000">种花</font></a></p> 
</td>                 
</tr>
<tr>
...
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">当前位置：花园</font></p>
</td>                 
