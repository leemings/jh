...
<td height="1" width="401" bgcolor="#C4DEFF" rowspan="10"><%if lx="高级公寓" then%><img src="image/wsj-01.jpg"><%end if%><%if lx="花园洋房" then%><img src="image/wsj-02.jpg"><%end if%><%if lx="豪华别墅" then%><img src="image/wsj-03.jpg"><%end if%> </td>                 
...
<p align="center"><a href="wc.asp"><font color="#000000">上厕所</font></a></p> 
</td>                 
<td height="164" width="403" bgcolor="#C4DEFF">
  <p align="center"><font color="#000000">当前位置：卫生间</font></p>
</td>                 
