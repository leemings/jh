<%
Application("aqjh_chatbgcolor")="006699"      '聊天室背景颜色代码
...
Application("aqjh_homepage")="http://www.happyjh.com"      '江湖主页
Application("aqjh_sn")="2015-09-14"      '江湖序列号，正版标志，修改后后果自负
Application("aqjh_user")="回首当年"      '江湖站长
Application("aqjh_qq")="865240608"      '站长qq
Application("aqjh_email")="865240608@qq.com"      '站长email
Application("aqjh_admin")="回首当年"      '设置10级聊管，多个用逗号隔开
Application("hidden_admin")="||"      '隐身人员，多个用逗号隔开
