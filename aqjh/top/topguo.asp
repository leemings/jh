...
<tr>
<td width="100%"><font color="#ffffff" size="2">国家高手排行TOP</font></td>
</tr>
</table>
<%
dim sql
dim rs
dim filename
sql="select * from 用户 where  国家<>'官府'  order by 武功+攻击+防御 desc"
...
bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr> 
      ...
      <td align="center" height="16" bgcolor="#336633" width="9%"><font color="#FFFFFF">国家</font></td>
      <td align="center" height="16" bgcolor="#336633" width="19%"><font color="#FFFFFF">职位</font></td>
<td align="center" height="16" bgcolor="#336633" width="19%"><font color="#FFFFFF">实力</font></td>
    </tr>
    <%do while not rs.eof%>
    <tr bgcolor="#85C2E0" onmouseout="this.bgColor='#85C2E0';"onmouseover="this.bgColor='#DFEFFF';"> 
      ...
      <td align="center" width="9%"><%=rs("国家")%> </td>
      <td align="center" width="19%"><%=rs("职位")%> </td>
