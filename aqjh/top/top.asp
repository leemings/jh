...
<tr bgcolor="#336633">
<td width="100%" height="21"><font color=#ffffff>20大女高手排行</font></td>
</tr>
</table>
<%
dim sql
dim rs
dim filename
sql="select * from 用户 where 身份<>'掌门' and 门派<>'官府'and 性别='女' order by 武功 desc"
Set rs= Server.CreateObject("ADODB.Recordset")
...
<p align="center"><font color=#999999 size=2><%Response.Write "序列号：<font color=blue>" & Application("aqjh_sn") & "</font>，授权给：<font color=blue>" & Application("aqjh_user") & "</font><br><font color=999999>" & Application("aqjh_copyright") & "</font>"%></font></p>
<p align="center">&nbsp;</p>
