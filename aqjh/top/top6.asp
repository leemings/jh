...
<tr>
<td width="100%"><font color="#ffffff" size="2">20位月泡点积分最多的(非官府)</font></td>
</tr>
</table>
<%
dim sql
dim rs
dim filename
sql="select * from 用户 where 门派<>'官府' and DateDiff('m',cdate(lasttime),now())=0 order by mvalue desc"
...
bordercolordark="#FFFFFF" cellpadding="0" bordercolor="#000000">
    <tr> 
      ...
      <td align="center" height="16" bgcolor="#336633" width="9%"><font color="#FFFFFF">总积分</font></td>
      <td align="center" height="16" bgcolor="#336633" width="12%"><font color="#FFFFFF">月积分</font></td>
      <td align="center" height="16" bgcolor="#336633" width="9%"><font color="#FFFFFF">登录次数</font></td>
      <td align="center" height="16" bgcolor="#336633" width="8%"><font color="#FFFFFF">会员等级</font></td>
      <td align="center" height="16" bgcolor="#336633" width="17%"><font color="#FFFFFF">体力</font></td>
    </tr>
    <%do while not rs.eof%>
    <tr bgcolor="#85C2E0" onmouseout="this.bgColor='#85C2E0';"onmouseover="this.bgColor='#DFEFFF';"> 
      ...
      <td align="center" width="9%"><font color=ff0000><%=rs("allvalue")%></font> 
      </td>
      <td align="center" width="12%"><font color="#0000FF"><b><%=rs("mvalue")%></b></font></td>
      <td align="center" width="9%"><font color=ff0000><%=rs("times")%></font></td>
      <td align="center" width="8%"><font color=ff0000><%=rs("会员等级")%></font></td>
