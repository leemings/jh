...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>门派职位高低排行</title>
<style type="text/css">
<!--
...
rs.open "SELECT * FROM 用户 where 门派='"&id&"' order by grade desc",conn
%>
<td width="60">
...
<td width="75">
<div align="center"><font color="#FFFFFF">管理等级</font></div>
</td>
<td width="66">
...
<div align="center"><font color="#FFFFFF"><%=rs("grade")%></font></div>
</td>
