...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>门派会员金卡排行</title>
<style type="text/css">
<!--
...
color="#FF6600"><b><font size="+1">爱 情 门 派</font></b></font></td>
</tr>
<tr align="center">
<td>
...
rs.open "SELECT * FROM 用户 where 门派='"&id&"' order by 会员金卡 desc",conn
%>
<td width="60">
<div align="center"><font color="#FFFFFF">姓名</font></div>
</td>
<td width="31">
<div align="center"><font color="#FFFFFF">金卡</font></div>
</td>
<td width="27">
...
<td width="75">
<div align="center"><font color="#FFFFFF">法力数</font></div>
</td>
<td width="66">
<div align="center"><font color="#FFFFFF">轻功数</font></div>
</td>
<td width="65">
<div align="center"><font color="#FFFFFF">转生次数</font></div>
</td>
<td width="32">
<div align="center"><font color="#FFFFFF">离派</font></div>
</td>
<td width="73">
...
<div align="center"><font color="#FFFFFF"><%=rs("会员金卡")%></font></div>
</td>
...
<div align="center"><font color="#FFFFFF"><%=rs("法力")%></font></div>
</td>
<td width="66" height="30">
<div align="center"><font color="#FFFFFF"><%=rs("轻功")%></font></div>
</td>
<td width="65" height="30">
<div align="center"><font color="#FFFFFF"><%=rs("转生")%></font></div>
</td>
<td width="32" height="30">
<div align="center"><font color="#FFFFFF"><%=rs("离派")%></font></div>
</td>
<td width="73" height="30">
<div align="center"><a href="mp3.asp?you=<%=rs("姓名")%>&amp;id=<%=rs("门派")%>"><font color="#FFFFFF">逐出师门</font></a></div>
</td>
<td width="73" height="30">
<div align="center"><a href="mp8.asp?you=<%=rs("姓名")%>&id=<%=rs("门派")%>"><font color="#FFFFFF">取消册封</font></a></div>
</td>
</tr>
<%
rs.movenext
