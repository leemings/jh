...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>门派月积分排行</title>
<style type="text/css">
<!--
...
rs.open "SELECT * FROM 用户 where 门派='"&id&"' order by mvalue desc",conn
%>
<td width="60">
...
<td width="66">
<div align="center"><font color="#FFFFFF">月积分</font></div>
</td>
<td width="65">
<div align="center"><font color="#FFFFFF">会员等级</font></div>
</td>
<td width="32">
