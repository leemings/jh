...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>门派等级排行</title>
<style type="text/css">
<!--
...
rs.open "SELECT * FROM 用户 where 门派='"&id&"' order by 等级 desc",conn
%>
<td width="60">
<div align="center"><font color="#FFFFFF">姓名</font></div>
</td>
<td width="31">
<div align="center"><font color="#FFFFFF">等级</font></div>
</td>
<td width="27">
...
<td width="75">
<div align="center"><font color="#FFFFFF">总积分</font></div>
</td>
<td width="66">
...
<div align="center"><font color="#FFFFFF"><%=rs("体力")%></font></div>
</td>
