...
if rs("会员等级")<>1  then
Response.Write "<script language=JavaScript>{alert('你不是一级会员啊!');location.href = 'javascript:history.back()';}</script>"
rs.close
set rs=nothing	
conn.close
set conn=nothing
...
set rs=nothing
set conn=nothing
says="<font color=red>【领取工资】["&aqjh_name&"]</font><font color=blue>今天刚领了<font color=red>"&money&"</font>两的工资,，1级会员另外领取<font color=red>1块</font>金卡，大家还不快去,等一下就没有了!</font>"
call showchat(says)
%>
<br>
</p>
...
<p align="center"><b><font color="#FF00FF">一级等级制会员另外领取金卡<img border="0" src="jk.GIF">1元！</font></b></p>
<p align="center">&nbsp;</p>
<p align="center">
