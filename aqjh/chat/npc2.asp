 ...
 if npc_inroom>=1 then
	...
	if n_zhuren<>aqjh_name then
	 ...
	 if rs("保护")=false and rs("门派")<>"出家" and rs("等级")>18 then
		select case npcr2
		case 1
		mess="<font color=red>【NPC攻击】</font>["&nl_name&"]用[NPC家族]招式{绝对诱惑}攻击"&aqjh_name&",杀伤" &  aqjh_name &"体力:<font color=red>-"& mekill&"</font>点，" &  aqjh_name &"气的直发晕……"
		conn.execute "update 用户 set 体力=体力-"& mekill &" where 姓名='" &  aqjh_name &"'"
		conn.execute  "update npc set n攻击率=n攻击率+1 where n姓名='"&nl_name&"'"
		case 5
		mess="<font color=red>【NPC必杀技】</font>["&nl_name&"]用[NPC家族]招式{一掌四式}攻击"&aqjh_name &",杀伤" &  aqjh_name &"体力:<font color=red>-"& mekill&"</font>点，打的" &  aqjh_name &"晕头转向……"
		conn.execute "update 用户 set 体力=体力-"& mekill &" where 姓名='" &  aqjh_name &"'"
		conn.execute  "update npc set n攻击率=n攻击率+1 where n姓名='"&nl_name&"'"
		case 8
	...
	case 6
		mess="<font color=red>【NPC感慨】</font>NPC人物<font color=blue>["&nl_name&"]</font>自言自语的说：“想我这一生纵横江湖,却敌不过["&aqjh_name&"]这个小辈!”"
	case 7
	...
	case 12
		mess="<font color=red>【NPC挑拨】</font><font color=blue>["&nl_name&"]</font>指着["&aqjh_name&"]骂道：“你这个小人,你开了保护和我打呀,不然你就一辈子当和尚出家,要不就穿着你的马甲保护好！”"
	case 14
		mess="<font color=red>【NPC动作】</font>NPC人物<font color=blue>["&nl_name&"]</font>感觉到腿有点酸,看看天,恩,明天要下雨了....</font>"
	case 20
		mess="<font color=red>【NPC恶作剧】</font>NPC人物<font color=blue>["&nl_name&"]</font>敲了敲["&aqjh_name&"]的脑袋，咚咚作响，打开一看，全是乱麻似的电线，不禁摇了摇头道：“这种机器人也太原始了！”"
	end select
	call showchat(mess)
    end select
 end if
...
sql="select * from 用户 where 姓名='"&aqjh_name&"'"
rs.open sql,conn,2,2
if rs("保护")=true and rs("门派")<>"出家" and rs("等级")>80 then
says="<bgsound src=wav/dgjj0.WAV loop=1><font color=red>【NPC自动用卡】<font color=balck>"&aqjh_name&"以为自己练功保护了就没事,<img src=sjfunc/1.gif>哪曾想NPC["&nl_name&"]使出一张解除卡，轻松的解除了"&aqjh_name&"的保护状态,这就是成为NPC["&nl_name&"]敌人的下场,保护了也无用!</font>"
call showchat(says)
conn.execute  "update 用户 set 保护=false where 姓名='"&aqjh_name &"'"
end if
if rs("保护")=false and rs("门派")<>"出家" and rs("等级")>80 then
rs.close
dz=int(rnd*80)+1
...
Select Case npcdj
case 1
says="<bgsound src=wav/dgjj0.WAV loop=1><font color=red>【NPC自动攻击】<font color=balck>"&aqjh_name&"正在自鸣得意<img src=sjfunc/1.gif>突然被NPC["&nl_name&"]使出一招["&dz_ok&"]，伤得不轻，体力下降"&mekill&"点，内力下降"&kill&"点，这就是成为NPC["&nl_name&"]敌人的下场!</font>"
case 2
says="<bgsound src=wav/dgjj0.WAV loop=1><font color=red>【NPC自动攻击】<font color=balck>"&aqjh_name&"正自以为是<img src=sjfunc/1.gif>哪里料到NPC["&nl_name&"]突然使出一招["&dz_ok&"]，伤得不轻，体力下降"&mekill&"点，内力下降"&kill&"点，这就是成为NPC["&nl_name&"]敌人的下场!</font>"
case 3
says="<bgsound src=wav/dgjj0.WAV loop=1><font color=red>【NPC自动攻击】<font color=balck>"&aqjh_name&"正在家中休息<img src=sjfunc/1.gif>却被NPC["&nl_name&"]使出一招["&dz_ok&"]，伤得不轻，体力下降"&mekill&"点，内力下降"&kill&"点，这就是成为NPC["&nl_name&"]敌人的下场!</font>"
case 4
says="<bgsound src=wav/dgjj0.WAV loop=1><font color=red>【NPC自动攻击】<font color=balck>"&aqjh_name&"正在花园赏花<img src=sjfunc/1.gif>突然NPC["&nl_name&"]从花丛中蹦出,使出一招["&dz_ok&"]，伤得不轻，体力下降"&mekill&"点，内力下降"&kill&"点，这就是成为NPC["&nl_name&"]敌人的下场!</font>"
case 5
says="<bgsound src=wav/dgjj0.WAV loop=1><font color=red>【NPC自动攻击】<font color=balck>"&aqjh_name&"正在同情人风花雪月<img src=sjfunc/1.gif>几曾想被NPC["&nl_name&"]使出一招["&dz_ok&"]，伤得不轻，体力下降"&mekill&"点，内力下降"&kill&"点，这就是成为NPC["&nl_name&"]敌人的下场!</font>"	
end select
call showchat(says)
conn.execute  "update 用户 set 体力=体力-"&mekill&",内力=内力-"&kill&" where 姓名='"&aqjh_name &"'"
conn.execute  "update npc set n攻击率=n攻击率+1 where n姓名='"&nl_name&"'" 
end if
end if
end if
