...
<table border="1" cellspacing="0" width="100%" cellpadding="1" cellspacing="0" bordercolorlight="#000000" bordercolordark="#FFFFFF">
  ...
  <tr bgcolor="#ffffff" onmouseover="this.bgColor='#85C2E0';" onmouseout="this.bgColor='#ffffff';"> 
    <td align="center"><a href="#" onclick="javascript:window.open('seenpc.asp?id=<%=rs("id")%>','seenpc','scrollbars=no,toolbar=no,menubar=no,location=no,status=no,resizable=no,width=610,height=450')" title="主人：<%=rs("n主人")%>,点击查看NPC详细状态"><%=rs("n姓名")%></a></td>
