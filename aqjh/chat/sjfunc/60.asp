...
if sf<>"掌门" and sf<>"长老" and sf<>"元老" then
	...
	conn.close
	set conn=nothing
	Response.Write "<script language=JavaScript>{alert('你不是掌门或者长老元老，不能发掌门令');}</script>"
	Response.End
end if
