...
i=instr(says,"$")
fnn1=mid(says,i+1)
says="<font color=red>【爱情魔法】<font color=" & saycolor & ">"+xyns()+"</font>"
towhoway=1
towho=aqjh_name
...
if rs("攻击") then
	...
	xyns="##<bgsound src=wav/xyns.wav loop=1>使用【爱情魔法】新阴那山,去了阴那山以后武功失去<font color=red>-100000</font>点,攻击增加<font color=red>+100</font>点,##连声说下次我还要去雁南飞!"
	rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
