...
i=instr(says,"$")
fnn1=mid(says,i+1)
says="<font color=red>【爱情魔法】<font color=" & saycolor & ">"+yxdf()+"</font>"
towhoway=1
towho=aqjh_name
...
if rs("内力") then
	...
	yxdf="##<bgsound src=wav/yxdf.wav loop=1>使用【爱情魔法】养心大法,体力失去<font color=red>-200000</font>点,内力增加<font color=red>+100000</font>点,以后不用买那么多药了！!"
	rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
