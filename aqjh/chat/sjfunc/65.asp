...
rs.open "select 配偶,道德,魅力,银两 FROM 用户 WHERE 姓名='"&aqjh_name&"'",conn,2,2
...
set conn=nothing
Application.Lock
Application("aqjh_dubos")=toname
Application.unLock
randomize()
regjm=int(rnd*3348998)
grdb="["&aqjh_name&"]向{"&toname&"}提出赌博要求，赌注10万白花花的银子！<input type=button value='石头' onClick="&chr(34)&"javascript:sitou"&regjm&".disabled=1;jianzi"&regjm&".disabled=1;bu"&regjm&".disabled=1;window.open('dubo.asp?name="&aqjh_name&"&db=1&aqjh_bingwen="&fn1&"','d')"&chr(34)&" name=sitou"&regjm&"><input type=button value='剪子' onClick="&chr(34)&"javascript:sitou"&regjm&".disabled=1;jianzi"&regjm&".disabled=1;bu"&regjm&".disabled=1;window.open('dubo.asp?name="&aqjh_name&"&db=2&aqjh_bingwen="&fn1&"','d')"&chr(34)&" name=jianzi"&regjm&"><input type=button value='布' onClick="&chr(34)&"javascript:sitou"&regjm&".disabled=1;jianzi"&regjm&".disabled=1;bu"&regjm&".disabled=1;window.open('dubo.asp?name="&aqjh_name&"&db=3&aqjh_bingwen="&fn1&"','d')"&chr(34)&" name=bu"&regjm&">"
end function
%>