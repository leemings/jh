...
<div align="center">
  ...
  <table border="0" width="80%" cellspacing="0" cellpadding="0" height="225" background="../bg.gif">
    <tr>
      <td width="88%" align="center" height="26" style="background-color: #800000; border-style: ridge; border-color: #800000">任务帮助</td>
    </tr>
    <tr>
      <td width="88%" height="162" valign="top">
        <font size="2" color="#008000">人族任务完成需要条件：</font><font color="#000000"><font size="2">银两1000000两、体力100000点、法力1000点、知质200、木属性2000点、江湖等级&gt;60级，每十分种可进行一次，每次任务完成后得到的奖励都有所不同，绝对超值！有可能增加战斗等级的哦！</font></font>
        <p><font size="2" color="#008000">魔族任务完成需要条件：</font><font size="2" color="#000000">银两1000000两、体力100000点、法力1000点、知质200、金木水火土属性各500点、江湖等级&gt;90级，每十分种可进行一次，每次任务完成后得到的奖励都有所不同，增加攻击与武功哦！</font></p>
        <p><font size="2" color="#008000">神族任务完成需要条件：</font><font size="2" color="#000000">银两1000000两、体力100000点、法力1000点、知质200、金木水火土属性各1000点、江湖等级&gt;120级，每十分种可进行一次，每次任务完成后得到的奖励都有所不同，增加防御与道德，有机会增加会员等级！</font>
<p><font size="2" color="#008000">共同条件：</font><font size="2" color="#000000">不同的种族有各自不同的属性。任务需要：神需要仙术。魔需要魔力，人类需要精神力，分别都是5点！~</font></font>
      </td>
    </tr>
    <tr>
      <td width="88%" height="28" valign="top">
        <b><font size="2" color="#0000FF">注：聊天室常用命令二区里有任务提交功能！！</font></b>
      </td>
    </tr>
  </table>
  </center>
