...
i=instr(says,"$")
fnn1=mid(says,i+1)
says="<font color=red>【快乐魔法】<font color=" & saycolor & ">"+dscj()+"</font>"
towhoway=1
towho=aqjh_name
...
if rs("金币") then
	...
	dscj="##<bgsound src=wav/dscj.wav loop=1>使用【快乐魔法】点石成金,武功失去<font color=red>-200000</font>点,金币增加<font color=red>+5</font>个,##觉的快乐江湖实在太有意思了!"
	rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
