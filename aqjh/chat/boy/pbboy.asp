...
temp=zt(0)&"|"&zt(1)&"|"&zt(2)&"|"&(clng(zt(3))-35)&"|"&(clng(zt(4))-5)&"|"&(clng(zt(5))+50)&"|"&(zg+1)&"|"&now()
...
conn.close
set conn=nothing
Response.Write "<script Language=Javascript>alert('提示：小孩锻炼完成：体:-35 攻:-5 感:+50 !');parent.f3.location.href = 'boy.asp';</script>"
%>
