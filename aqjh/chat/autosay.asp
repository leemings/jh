...
if aqjh_name="" then Response.Redirect "chaterr.asp"
...
if DateDiff("n",Session("aqjh_savetime"),now())>=15 then
	Response.Write "<script Language=Javascript>parent.clsok=1;if(parent.hang>500){parent.qp();}parent.f3.location.href='savevalue_auto.asp';</script>"
end if
n=Year(date())
y=Month(date())
r=Day(date())
...
says="<font color=red>【泡点精灵】[</font><font color=#000000>" & aqjh_name & ""& "</font><font color=red>]自动泡点中．．．人有事暂时不在</font><font color=#ff00ff>↓</font><font color=red>要找我请留言</font><font color=#ff00ff><b>↑</b></font><font color=red>"&t&"</font>"			'聊天数据
