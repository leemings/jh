...
if id="001" or id="002" then
	...
	Application.UnLock
	diuqi=aqjh_name&"掉出聊天室，尚未保存存点总计:<a href='dq.asp' target='d'><b><font color=red>+"&mycd&"</font></b></a>点,谁抢到是谁的…"
	towhoway=0
	saycolor="660099"
	addwordcolor="660099"
	addsays="对"
...
Application.UnLock
	...
	Application("aqjh_diuqi")="v|"&to1&"|"&mycd&"|"&now()
	Application.UnLock
	diuqi=aqjh_name&"<font color=#000000>试图一机多号，被系统请出了聊天室！大家快抢存点吧:</font><a href='dq.asp' target='d'><b><font color=red> +"&mycd&" </font></b></a><font color=#000000>点</font>"
        act="消息"
	towhoway=0
	saycolor="660099"
	addwordcolor="660099"
...
Case "002"
	nl="本窗口即将被关闭。<br><br>原因：<br>　　你超过 " & Application("aqjh_maxtimeout") & " 分钟没有发言，为减轻服务器负担，系统自动清除你所占用的资源。<br><br>解决方法：<br>　　关闭此窗口，重新到登录页面输入用户名和密码进行登录。"
Case else
	nl="　　对不起，该出错类型未被登记。"
End Select
nl="<p>" & nl & "</p>"%><html>
