...
<div align=center><font color="#FFFF00" style="font-size:9pt">点歌系统 | <a href=swflist.asp><font color="#FFFF00" style="font-size:9pt">MTV点播</font></a></font></div>
<hr size=1 color=FFFF00>
<table border="0" width="100%">
<form method="post" action="songplay.asp?" name="" target="ps">
<tr>
<td>
<p> <font color="#FFFF00" style="font-size:9pt">选择MP3列表:</font><br>
...
<br>
祝福话语<br>
<input type="text" name="zhufu" size="17" value="祝大家每天都有一个好心情!" maxlength="50"><br>
朋友名字<br>
    <select name="to1">
      <%useronlinename=Application("aqjh_useronlinename"&session("nowinroom"))
