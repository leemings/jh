...
if Application("aqjh_kl")=0 then
	Response.Write "<script Language=Javascript>alert('提示：你小子是不是没事找事呀，哪里有烟花？！');</script>"
	response.end
end if
...
if rs("体力")<-100 then
	conn.execute "update 用户 set 状态='死',事件原因='烟花|"&fn1&"' where 姓名='" & aqjh_name &"'"
	conn.execute "insert into l(b,a,c,e,d) values ('" & aqjh_name & "',now(),'烟花','放烟花死了','人命')"
	kl="<img src='img/yianhua.gif'>哼！，就["&aqjh_name&"]你这体力也想放烟花？没门！"
	call boot(aqjh_name,"烟花，操作者：烟花，放烟花？没门！")
else
dim js(10)
js(0) ="骨头"
js(1) ="蓝宝石"
...
kl="["&aqjh_name&"]放了烟花，好玩呀，漂亮呀，增加魅力<img src='img/heart.gif'>1000点！银两<img src='img/251.gif'>"&tempjs*40&"两！得到了[<b><font color=red>"&js(myxy)&"</font></b>]1个……"
end if
rs.close
set rs=nothing
conn.close
