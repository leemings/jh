...
if rs("体力")<-100 then
	conn.execute "update 用户 set 状态='死',事件原因='舞男|"&fn1&"' where 姓名='" & aqjh_name &"'"
	conn.execute "insert into l(b,a,c,e,d) values ('" & aqjh_name & "',now(),'舞男','追舞男被打死','人命')"
	kl="<img src='img/wn.gif'>哼！，就["&aqjh_name&"]你这体力也想泡我？没门！"
	call boot(aqjh_name,"舞男，操作者：舞男，想追我？没门！")
else
dim js(10)
js(0) ="骨头"
js(1) ="蓝宝石"
...
kl="恭喜["&aqjh_name&"]追到了舞男，增加魅力<img src='img/heart.gif'>1000点！银两<img src='img/251.gif'>"&tempjs*40&"两！得到了[<b><font color=red>"&js(myxy)&"</font></b>]1个……"
end if
rs.close
set rs=nothing
conn.close
