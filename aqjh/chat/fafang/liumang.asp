...
if rs("体力")<-100 then
	conn.execute "update 用户 set 状态='死',事件原因='流氓|"&fn1&"' where 姓名='" & aqjh_name &"'"
	conn.execute "insert into l(b,a,c,e,d) values ('" & aqjh_name & "',now(),'流氓','因勇打流氓所牺牲','人命')"
	kl="<img src='img/kl.gif'>哈哈，["&aqjh_name&"]拿着棒子来打流氓，谁知道体力不如人家，["&aqjh_name&"]挨了流氓一招晴空霹雳，死翘翘了………"
	call boot(aqjh_name,"流氓，操作者：流氓，敢打我，找死！")
else
dim js(10)
js(0) ="骨头"
js(1) ="蓝宝石"
...
conn.execute "update 用户 set 魅力=魅力+1000,w6='"&zstemp&"' where 姓名='" & aqjh_name & "'"
kl="哈哈，["&aqjh_name&"]拿着棒子打跑了来江湖骚扰美女的流氓，得到了官府奖励魅力1000点！在打败流氓后，"&aqjh_name&"得到了[<b><font color=red>"&js(myxy)&"</font></b>]1个……"
end if
rs.close
set rs=nothing
conn.close
