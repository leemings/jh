...
if rs("体力")<-60000 then
	conn.execute "update 用户 set 状态='僵尸王',身份='僵尸王',事件原因='僵尸|"&fn1&"' where 姓名='" & aqjh_name &"'"
	conn.execute "insert into l(b,a,c,e,d) values ('" & aqjh_name & "',now(),'僵尸','因勇打僵尸所牺牲','人命')"
	kl="<img src='pic/kl.gif'>太不幸了，["&aqjh_name&"]为了保护大家的安全，舍身取义，被僵尸咬的七零八落，死翘翘了变成了一只僵尸王从此江湖多事了.各位大虾还是小心点………"
	call boot(aqjh_name,"僵尸，操作者：僵尸，打我呀找死！")
else
dim js(10)
js(0) ="骨头"
js(1) ="蓝宝石"
...
kl="我call,英雄，真是英雄，["&aqjh_name&"]与僵尸大打出手……僵尸终于倒下了，而他自己也伤的不轻，官府奖励<img src='img/251.gif'>"&tempjs*1&"两！在打败僵尸后，"&aqjh_name&"得到了[<b><font color=red>"&js(myxy)&"</font></b>]1个……"
end if
rs.close
set rs=nothing
conn.close
