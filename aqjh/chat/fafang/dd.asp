...
if Application("aqjh_yb")=0 then
	Response.Write "<script Language=Javascript>alert('提示：你小子来晚了，豆点没有了...');</script>"
	response.end
end if
...
conn.execute "update 用户 set 泡豆点数=泡豆点数+"& temp &" where 姓名='" & aqjh_name &"'"
yb="今天真是走运，收到站长送的豆点，呵。。。因此：["&name&"]得到豆点:"&temp&"点!"
conn.close
set conn=nothing
