...
if rs("内力")<-5000 then
	conn.execute "update 用户 set 状态='死',事件原因='木妖|"&fn1&"' where 姓名='" & aqjh_name &"'"
	conn.execute "insert into l(b,a,c,e,d) values ('" & aqjh_name & "',now(),'木妖','因勇打木妖所牺牲','人命')"
	kl="<img src='pic/kl.gif'>太不幸了，["&aqjh_name&"]为了保护江湖人的安全，舍身取义，被木妖打的七零八落，死翘翘了………"
	call boot(aqjh_name,"木妖，操作者：木妖，打我呀找死！")
else
dim js(10)
js(0) ="骨头"
js(1) ="蓝宝石"
...
kl="英雄降世，超级英雄，["&aqjh_name&"]与木妖抗击……木妖终于敌不过中原武功，而他自己也伤的不轻，官府奖励"&tempjs*1&"法力！在打败木妖后，"&aqjh_name&"得到了[<b><font color=red>"&js(myxy)&"</font></b>]1个……"
end if
rs.close
set rs=nothing
conn.close
