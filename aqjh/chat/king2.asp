...
<tr><td><a href=# onClick="window.open('../jhmp/money.asp','aqjh_win','scrollbars=0,resizable=0,width=430,height=440')">领取工资</a></td><td><a href=# onclick="window.open('../yamen/gmhx.asp','aqjh_win','scrollbars=1,resizable=1,width=400,height=300')">更改姓名</a></td></tr>
...
%>
<table width=120>
<tr align=center><td><a href="face.asp" scrollbars="0" resizable="0" width="740" height="450">江湖头像</A></td><td><a href=# onClick="window.open('../jhhy/xrf/ly.asp','aqjh_win','scrollbars=0,resizable=0,width=700,height=400')">新人领卡</A></td></tr>
<tr align=center><td><a href=# onClick="window.open('../xcj/yxs/yxs.ASP','aqjh_win','scrollbars=0,resizable=0,width=700,height=470')">月薪领取</A></td><td><a href=# onClick="window.open('../jhhy/zllw/zllw.asp','aqjh_win','scrollbars=1,resizable=0,width=740,height=450')">周六礼物</A></td></tr>
<tr align=center><td><a href=# onClick="window.open('../jhmp/bxmp.asp','aqjh_win','scrollbars=1,resizable=0,width=700,height=400')">门派排行</A></td><td><a href=# onClick="window.open('../jhhy/zwlw/hy-ffkp.asp','aqjh_win','scrollbars=0,resizable=0,width=700,height=420')">周五礼物</A></td></tr>
...
<tr align=center><td><a href=# onClick="window.open('../hcjs/pig/zhu.ASP','aqjh_win','scrollbars=0,resizable=0,width=700,height=420')">养猪致富</A></td><td><a href=# onClick="window.open('jhjh/index.ASP','aqjh_win','scrollbars=0,resizable=0,width=700,height=420')">进化系统
<tr align=center><td><a href=# onClick="window.open('../jhhy/zmlwp/hy-ffkp.asp','aqjh_win','scrollbars=0,resizable=0,width=740,height=450')">周末礼品</A></td><td><a href=# onClick="window.open('../jhhy/xrf/lk.asp','aqjh_win','scrollbars=0,resizable=0,width=700,height=400')">新人领卡</A></td></tr>
<tr align=center><td><a href=# onClick="window.open('../jhhy/zxjl/hy-ffkp.asp','aqjh_win','scrollbars=0,resizable=0,width=700,height=470')">在线奖励</A></td><td><a href=# onClick="window.open('../jhhy/liwu/hy-ffkp.asp','aqjh_win','scrollbars=1,resizable=0,width=740,height=450')">节日礼物</A></td></tr>
