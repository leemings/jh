...
if towho<>Application("aqjh_automanname") and towho<>"大家" and Instr(Application("aqjh_useronlinename"&nowinroom)," "&towho&" ")=0 and towho<>Application("figo") and gw=0 then
...
Application.UnLock
'暂离开
if Instr(LCase(application("aqjh_zanli")),LCase("!"&aqjh_name&"!"))>0 and left(says,4)<>"/回来$" and aqjh_grade<10 then
	Response.Write "<script Language=Javascript>alert('您正在“暂离”状态中，请使用“我回来啦”功能解除！');</script>"
	response.end
end if
'判断对方操作
if Instr(LCase(application("aqjh_zanli")),LCase("!"&towho&"!"))>0 and left(says,4)<>"/回来$" then
