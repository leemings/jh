...
conn.execute "insert into l(b,a,c,e,d) values ('" &st & "',now(),'吝啬','体力不足累死','人命')"
	...
	kl="<font color=#0000FF>"&st&"</font>一招打死了怪物，获取怪物身上的攻击"&tempjs*30&"点！"
	end if
	rs.close
set rs=nothing
conn.close
