...
conn.execute "insert into l(b,a,c,e,d) values ('" & st & "',now(),'吝啬','体力不足累死','人命')"
	...
	conn.execute "update 用户 set 银两=银两+"&tempjs*1000&" where 姓名='" & st & "'"
	kl="<font color=#0000FF>"&st&"</font>成功消灭火史莱姆，夺取它身上的银两"&tempjs*1000&"两！"
	end if
	rs.close
set rs=nothing
conn.close
