...
call boot(st,"怪物，操作者：怪物，咆哮！")
	...
	conn.execute "update 用户 set 法力=法力+"& tempjs *30&" where 姓名='" & st & "'"
	kl="<font color=#0000FF>"&st&"</font>历尽千辛万苦，跋涉哥特山，赶走了魔幻剑魂，成功地提高自己的法力"&tempjs*30&"点！"
	end if
	rs.close
set rs=nothing
conn.close
