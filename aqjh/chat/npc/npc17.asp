...
conn.execute "insert into l(b,a,c,e,d) values ('" &st & "',now(),'吝啬','体力不足累死','人命')"
	...
	conn.execute "update 用户 set 体力=体力+"& tempjs *30&" where 姓名='" & st & "'"
	kl="<font color=#0000FF>"&st&"</font>一招打死了怪物，顿时体力上涨"&tempjs*30&"点！"
	end if
	rs.close
set rs=nothing
conn.close
