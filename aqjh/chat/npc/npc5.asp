...
conn.execute "insert into l(b,a,c,e,d) values ('" & st & "',now(),'吝啬','体力不足累死')"
...
call boot(st,"怪物，操作者：怪物，咆哮！")
	...
	kl="<font color=#0000FF>"&st&"</font>一拳打死灯神,获得当地官府奖励白银"&tempjs*1000&"两！"
	end if
	rs.close
set rs=nothing
conn.close
