...
conn.execute "insert into l(b,a,c,e,d) values ('" &st & "',now(),'吝啬','体力不足累死','人命')"
	...
	conn.execute "update 用户 set 道德=道德+"& tempjs *20&" where 姓名='" & st & "'"
	kl="<font color=#0000FF>"&st&"</font>一招打死了怪物，为民除了一大害，道德提高"&tempjs*20&"点！"
	end if
	rs.close
set rs=nothing
conn.close
