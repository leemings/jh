...
conn.execute "update 用户 set  w6='"&duyao&"',内力=内力+800,体力=体力+1200,allvalue=allvalue+1,银两=银两+5000 where 姓名='"&aqjh_name&"'"
rs.close
set rs=nothing
conn.close
set conn=nothing
says="<font color=red>【好消息】</font><font color=red>野兽已经被'"&aqjh_name&"'打死，真是英雄少年呀，请大家放心聊天吧。</font>"		'聊天数据
says=replace(says,"'","\'")
