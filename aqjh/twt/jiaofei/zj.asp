...
Application.Lock
Application("aqjh_dalie")="土匪" 
Application.UnLock
says="<bgsound src=wav/tufei.wav loop=1><font color=red>【消息】</font><font color=red>突然一群土匪<img src=img/jiao.gif>闯入江湖抢劫，请高手们快去剿匪啊。</font>"			'聊天数据
says=replace(says,"'","\'")
