...
if dj<100 then 
	  Response.Write "<script Language=Javascript>alert('提示：您的等级不符合进入条件。进入初级怪物区的限制是：等级>100。！');location.href = 'javascript:history.go(-1)';</script>"
	  Response.End
end if
if tl<0 then 
...
%><br><br>
<div align=center><img src=../pic/xwg.gif width=160 height=128></div>
<p align=center> <a href=xwg1.asp><font color=ffff00><b>发动攻击</b></font></a> <a href=zhg.asp><font color=red><b>唤醒怪物</b></font></a></p>
