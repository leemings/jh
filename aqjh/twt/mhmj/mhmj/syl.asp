...
if hydj<1 and dj<150 then 
	            Response.Write "<script Language=Javascript>alert('提示：您的等级不符合进入条件。进入高级怪物区的限制是：等级150以上的会员。！');location.href = 'javascript:history.go(-1)';</script>"
	            Response.End
end if
if tl<0 then 
...
%><br><br>
<div align=center><img src=../pic/syl.gif width=160 height=128></div>
<p align=center> <a href=syl1.asp><font color=ffff00><b>发动攻击</b></font></a> <a href=zhy.asp><font color=red><b>唤醒怪物</b></font></a></p>

<p align=left><font color=cccccc size=2>说明：<font color=00ff00>每个小时后二十分钟</font>，可以来梦幻魔界打猎，首先体力内力要大于<font color=ffff00>50000</font>点，注意点别挂就是的，呵呵，打死怪物后会<font color=ffff00>根据怪物的属性级别可以随机获得：锻造武器的物品、积分（存点）、金币、卡片、配药、高级装备</font>等。当怪物被消灭后，想要再打，就必须将其<font color=00FFFF>唤醒</font>，这需要耗费您的<b><b><font color=00ff00>2000</font></b></b>点法力，还要注意您唤醒的怪物其他玩家也可以打，要抓紧时间哦。</font></p>
</table><br><br>
