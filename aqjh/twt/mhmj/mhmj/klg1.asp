...
if InStr(http,"mhmj/klg.asp")=0 then 
...
if nl<150000 then 
	Response.Write "<script Language=Javascript>alert('提示：内力小于150000不能进入！');location.href = 'javascript:history.go(-1)';</script>"
	Response.End
end if
if fl<70000 then 
	Response.Write "<script Language=Javascript>alert('提示：法力小于70000不能进入！');location.href = 'javascript:history.go(-1)';</script>"
	Response.End
end if
dim js(21)
js(0) ="骨头"
...
if gwtl<0 then
	Response.Write "<script Language=Javascript>alert('提示："&aqjh_name&"恭喜你！"&gwm&"已经被你成功消灭，获得"&js2(myxa)&"1个，"&js(myxy)&"5个，"&js1(myxx)&"15个，金币30个。积分（存点）"&s3&"点！！');location.href = 'javascript:history.go(-1)';</script>"
else
...
conn.close
set conn=nothing
says="<font color=RED><b>〖梦幻魔界消息〗</b></font><font color=green>[<font color=red><b>"& aqjh_name &"</b></font>]经过一场苦战，已将[<font color=red><b>"&gwm&"</b></font>]消灭，并且从怪物身上获得[<font color=red><b>"&js(myxy)&"</b></font>]5个、[<font color=red><b>"&js1(myxx)&"</b></font>]15个、[<font color=red><b>"&js2(myxa)&"</b></font>]1个和存点[<font color=red><b>"&s3&"</b></font>]点，金币[<font color=red><b>30</b></font>]个！<font color=green>[<font color=red><b>"& aqjh_name &"</b></font>]的<font color=red><b>【会员等级】</b></font>为[<font color=red><b>"&hydj&"</b></font>]级！他进入梦幻魔界的<font color=red><b>【时间限制】</b></font>为：[<font color=red><b>"&jgsj&"</b></font>]秒</font>"			'聊天数据
says=replace(says,"'","\'")
