...
rs.open "select 体力,操作时间,性别 from 用户 where 姓名='"&aqjh_name&"'",conn
...
if rs("性别")<>"男" then
	...
	conn.close
	set conn=nothing
	Response.Write "<script language=JavaScript>{alert('你个女人来这里作什么不想活了！');location.href = 'javascript:history.back()';}</script>"
	Response.End 
end if
...
conn.close
set conn=nothing
says="<font color=red>【皮条客】</font><font color=green>["&aqjh_name&"]今天当了一天的皮条客,嘿嘿，获得银两10000！体力下降500可要多多休息哦^O^</font>"
act="消息"
towhoway=0
towho="大家"
addwordcolor="660099"
...
<tr>
        ...
        <tr>
<td height="182" valign="top">辛辛苦苦作了一天皮条客，你获得银两10000！体力下降500！<Br><Br>
          </td>
</tr>
