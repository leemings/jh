...
if rs("体力")<200 then
	...
	conn.close
	set conn=nothing
	Response.Write "<script language=JavaScript>{alert('你的体力不够200，不可以在这里工作！');location.href = 'javascript:history.back()';}</script>"
	Response.End 
end if
conn.execute "update 用户 set 体力=体力-200,银两=银两+8000,操作时间=now() where 姓名='"&aqjh_name&"'"
rs.close
set rs=nothing
conn.close
set conn=nothing
says="<font color=red>【搬运工】</font><font color=green>["&aqjh_name&"]辛辛苦苦作了一天搬运工，获得银两8000！体力下降200</font>"
act="消息"
towhoway=0
towho="大家"
addwordcolor="660099"
...
<tr>
        ...
        <tr>
<td height="182" valign="top">辛辛苦苦作了一天搬运工，你获得银两8000！体力下降200！<Br><Br>
          </td>
</tr>
