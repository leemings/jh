...
if rs("体力")<300 then
	...
	conn.close
	set conn=nothing
	Response.Write "<script language=JavaScript>{alert('你的体力不够300，不可以在这里工作！');location.href = 'javascript:history.back()';}</script>"
	Response.End 
end if
conn.execute "update 用户 set 体力=体力-300,银两=银两+12000,操作时间=now() where 姓名='"&aqjh_name&"'"
rs.close
set rs=nothing
conn.close
set conn=nothing
says="<font color=red>【官府衙差】</font><font color=green>["&aqjh_name&"]辛辛苦苦作了一天官府衙差，你获得银两12000！体力下降300</font>"
act="消息"
towhoway=0
towho="大家"
addwordcolor="660099"
...
<tr>
        ...
        <tr>
<td height="182" valign="top">辛辛苦苦作了一天官府衙差，你获得银两12000！体力下降300！<Br><Br>
          </td>
</tr>
