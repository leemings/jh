...
rs.open "SELECT * FROM w WHERE b=" & aqjh_id & " and i>=5 and a='矿石'",conn
...
rs.close
rs.open "select id from x where a='清凉油' and b="&aqjh_id
If Rs.Bof OR Rs.Eof then
	conn.execute "insert into x(a,b,c,d,e) values ('清凉油'," & aqjh_id &",1,'魅力',1500)"
else
	id=rs("id")
