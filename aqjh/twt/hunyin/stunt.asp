...
if rs.bof or rs.eof then
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('提示：["&aqjh_name&"]你还没有配偶呢，来作什么！');window.close();</script>"
	response.end
end if
rs.close
%>
...
<div align="center"> <font color="#FFFFFF" ><b><font color="#000000">夫 妻 合 体 技
设 置</font></b></font><font color="#000000"><br>
<br>
</font> </div>
