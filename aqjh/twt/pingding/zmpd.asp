...
<BR>
<p align="center"><font size="6" face="隶书">掌门评定</font></p>
...
<tr bgcolor="#3399FF">
    ...
    <td width=80 align=center><font color=white>门派</td>
    ...
    <td width=220 align=center><font color=white>评定参考</td>
</tr>
<%
date2=split(date(),"-")
rs.open "SELECT * FROM 用户 where 身份='掌门' and 门派<>'官府' order by grade DESC",conn
...
if rjzx<30 or xsts>=5 then
 pdck="<font color=red><b>该掌门严重失职，建议撤职</b></font>"
elseif rjzx>=30 and rjzx<60 then
 pdck="<b>该掌门表现很差，请尽快改正</b>"
elseif rjzx>=60 and rjzx<180 and xsts<5 then
 pdck="<b>该掌门表现一般，请继续努力</b>"
elseif rjzx>=180 and xsts<3 then
 pdck="<font color=green><b>该掌门认真负责，建议奖励</b></font>"
elseif ipc(ipcname)>=5 then
 pdck="<font color=red><b>该掌门ip变动频繁，请去论坛说明原因</b></font>"
else
 pdck="<b>该掌门表现一般，请继续努力</b>"
end if
...
<tr bgcolor="" onmouseout="this.bgColor='';"onmouseover="this.bgColor='#DFEFFF';">
    ...
    <td align=center width=80><%=rs("门派")%></td>
    ...
    <td align=center width=40><%=ipc(ipcname)%></td>
    <td align=center width=220><%=pdck%></td>
</tr>
<%
rs.movenext
loop
