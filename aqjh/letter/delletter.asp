...
myid=rs("id")
rs.close
rs.open "select * from letter where yhid="&myid&" and id="&id,conn
if rs.bof or rs.eof then
	call myclose("提示：找不到你要删除的短信！",0)
end if
bt=rs("bt")
if del<>true then
	conn.execute "update letter set del=true where id="&id
else
...
<DIV align=center> 成功删除标题为：<font color=red><%=bt%></font> 的短消息！<br>
<br>
<br>
<br>
