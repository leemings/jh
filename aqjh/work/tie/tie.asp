...
id=dostone style="LEFT: 381px; POSITION: absolute; TOP: 130px"></SPAN>
<SPAN id=dosteel style="LEFT: 35px; POSITION: absolute; TOP: 180px"><A
href="#"
onclick="setTimeout('golian()',0)"><IMG alt=炼铁 border=0 class=csstext2 height=25
src="image/liantie.gif" width=30></A></SPAN></P>
<DIV id=sjdiv
style="BACKGROUND-IMAGE: url(/tribe/hut/stone/back3.gif); BORDER-BOTTOM: #000000 1px; BORDER-LEFT: #000000 1px; BORDER-RIGHT: #000000 1px; BORDER-TOP: #000000 1px; HEIGHT: 100px; LEFT: 250px; POSITION: absolute; TOP: 160px; VISIBILITY: hidden; WIDTH: 100px; zindex: 100; layer-background-image: url(/tribe/hut/stone/back3.gif)"><BR>
