<%
Response.Write "<script Language=Javascript>parent.fs.location.href = 'TIE.asp';</script>"
%>
<html>
<head>
<title>深山练铁</title>
  ...
  <table width="100%" border="1">
    <tr> 
      <td width="21%" height="19"> 
        <div align="center"><font size="-1">铁块数：</font></div>
      </td>
      <td width="14%" height="19" id="fm1"> 
        <div align="center"><font size="-1"></font></div>
      </td>
      <td width="16%" height="19"> 
        <div align="center"><font size="-1">练铁数:</font></div>
      </td>
...
<FORM action="tiejl.asp" method=POST name="shiform" target="ig">
