...
rs.open "Select * From l where d='操作' Order by a DESC",conn,3,3
...
<div align="center">[<a href="jl12.asp?page=<%=page-1%>">上一页</a>][第<%=page%>页][<a href="jl12.asp?page=<%=page+1%>">下一页</a>]</div>
</td>
</tr>
</table>
</table>
