...
rs.open "Select * From l where d='斩首' Order by a DESC",conn,3,3
...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>-江湖斩首</title>
...
<tbody>
<tr>
<td height="15" width="100%"><font color="red"><b>江湖斩首</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<tr bgcolor="#FFFFFF">
<td width="20%">
<div align="center"><font color="#FF6600"> 执 法 官 </font></div>
</td>
<td width="25%">
<div align="center"><font color="#FF6600"> 时 间 </font></div>
</td>
<td width="19%">
<div align="center"><font color="#FF6600"> 斩 首 对 象 </font></div>
</td>
<td width="36%">
<div align="center"><font color="#FF6600"> 被 斩 原 因 </font></div>
</td>
</tr>
<%
count=0
...
<div align="center">[<a href="jl13.asp?page=<%=page-1%>">上一页</a>][第<%=page%>页][<a href="jl13.asp?page=<%=page+1%>">下一页</a>]</div>
</td>
</tr>
</table>
</table>
...
function musers()
dim tmprs
tmprs=conn.execute("Select count(*) As 斩首 from l where d='斩首'")
musers=tmprs("斩首")
set tmprs=nothing
