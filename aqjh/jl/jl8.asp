...
PageSize = 15
rs.open "delete * from l where a<now()-1",conn,3,3
rs.open "Select * From l where d='册封' Order by a DESC",conn,3,3
...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>-江湖册封</title>
...
<tbody>
<tr>
<td height="15" width="100%"><font color="red"><b>江湖册封</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<div align="center">[<a href="jl8.asp?page=<%=page-1%>">上一页</a>][第<%=page%>页][<a href="jl8.asp?page=<%=page+1%>">下一页</a>]</div>
</td>
</tr>
</table>
</table>
