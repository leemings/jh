...
rs.open "Select * From l where d='逮捕' Order by a DESC",conn,3,3
...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>-江湖逮捕</title>
...
<tbody>
<tr>
<td height="15" width="100%"><font color="red"><b>江湖逮捕</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<tr bgcolor="#FFFFFF">
<td width="11%">
<div align="center"><font color="#FF6600"> 管 理 员 </font></div>
</td>
<td width="18%">
<div align="center"><font color="#FF6600"> 时 间 </font></div>
</td>
<td width="12%">
<div align="center"><font color="#FF6600"> 管理对象 </font></div>
</td>
<td width="59%">
<div align="center"><font color="#FF6600"> 事 情 原 因 </font></div>
</td>
</tr>
<%
count=0
...
<div align="center">[<a href="jl3.asp?page=<%=page-1%>">上一页</a>][第<%=page%>页][<a href="jl3.asp?page=<%=page+1%>">下一页</a>]</div></td></tr></table></table></div></body>