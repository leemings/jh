...
rs.open "Select * From l where d='警告' Order by a DESC",conn,3,3
...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>-江湖警告</title>
...
<tbody>
<tr>
<td height="15" width="100%"><font color="red"><b>江湖警告</b></font></font></td>
</tr>
</tbody>
</table>
<div align="center">
...
<div align="center">[<a href="jl2.asp?page=<%=page-1%>">上一页</a>][第<%=page%>页][<a href="jl2.asp?page=<%=page+1%>">下一页</a>]</div>
</td>
</tr>
</table>
</table>
