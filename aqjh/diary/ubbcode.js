...
document.myform.diary.value+=NewCode;
document.myform.diary.focus();
return;
}
...
function AddText(text) {
	if (document.myform.diary.createTextRange && document.myform.diary.caretPos) {      
		var caretPos = document.myform.diary.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else document.myform.diary.value += text;
	document.myform.diary.focus(caretPos);
}
function inputs(str)
{
AddText(str);
...
document.myform.diary.value+=ToAdd;
document.myform.diary.focus();
}
function Cimage() {
var FoundErrors = '';
...
function paste(text) {
	if (opener.document.myform.diary.createTextRange && opener.document.myform.diary.caretPos) {      
		var caretPos = opener.document.myform.diary.caretPos;      
		caretPos.text = caretPos.text.charAt(caretPos.text.length - 1) == ' ' ?
		text + ' ' : text;
	}
	else opener.document.myform.diary.value += text;
	opener.document.myform.diary.focus(caretPos);
}
...
document.myform.diary.value=fontbegin+document.myform.diary.value+fontend;
document.myform.diary.focus();
}
}
...
function insertsmilie(smilieface){
	...
	document.myform.diary.value+=smilieface;
}