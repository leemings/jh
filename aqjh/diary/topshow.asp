...
news=1
do while not rs1.eof and news<=6
select case rs1("保密")
case "1"
	bm="公开欣赏"
case "2"
...
response.write "document.write('<img height=14 src=diary/images/hot.gif width=11><a href=diary/show.asp?id=" & rs1("id") & " & wj=list.asp title=" & chr(34) & "作者：" & rs1("用户名") & " 鲜花:" & rs1("鲜花") & " 鸡蛋:" & rs1("鸡蛋") & " 留言:" & rs1("留言数") & " 方式:" & bm & "" & chr(34) & " target=blank>" & rs1("日记标题") & "</a><br>');"
news=news+1
rs1.movenext
loop
end if
