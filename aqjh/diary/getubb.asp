<img onclick=Cbold() src="pic\bold.gif" width="18" height="18" alt="粗体" border="0">
<img onclick=Citalic() src="pic\italicize.gif" width="18" height="18" alt="斜体" border="0">
<img onclick=Cunder() src="pic\underline.gif" width="18" height="18" alt="下划线" border="0">
<img onclick=Ccenter() src="pic\center.gif" width="18" height="18" alt="居中" border="0">
<img onclick=Curl() src="pic\url1.gif" width="18" height="18" alt="超级连接" border="0">
<img onclick=Cemail() src="pic\email1.gif" width="18" height="18" alt="Email连接" border="0">
<img onclick=Cimage() src="pic\image.gif" width="18" height="18" alt="图片" border="0">
<img onclick=Cswf() src="pic\swf.gif" width="18" height="18" alt="Flash图片" border="0">
<img onclick=Cdir() src="pic\Shockwave.gif" width="18" height="18" alt="Shockwave文件" border="0">
<img onclick=Crm() src="pic\rm.gif" width="18" height="18" alt="realplay视频文件" border="0">
<img onclick=Cwmv() src="pic\mp.gif" width="18" height="18" alt="Media Player视频文件" border="0">
<img onclick=Cmov() src="pic\qt.gif" width="18" height="18" alt="QuickTime视频文件" border="0">
<img onclick=Cquote() src="pic\quote1.gif" width="18" height="18" alt="引用" border="0">
<IMG onclick=Cfly() height=18 alt=飞行字 src="pic\fly.gif" width=18 border=0>
<IMG onclick=Cmarquee() height=18 alt=移动字 src="pic\move.gif" width=18 border=0>
<IMG onclick=Cguang() height=18 alt=发光字 src="pic\glow.gif" width=18 border=0>
<IMG onclick=Cying() height=18 alt=阴影字 src="pic\shadow.gif" width=18 border=0>
<br>字体:<SELECT onchange="if(this.options[this.selectedIndex].value!=''){showfont(this.options[this.selectedIndex].value);this.options[0].selected=true;}else {this.selectedIndex=0;}" name=font>
<option value="宋体" selected>宋体</option>
<option value="楷体_GB1812">楷体</option>
...
<option style="background-color:#B18182;color: #B18182" value="#B18182">#B18182</option>
<option style="background-color:#FFFAF0;color: #FFFAF0" value="#FFFAF0">#FFFAF0</option>
<option style="background-color:#188B18;color: #188B18" value="#188B18">#188B18</option>
...
<option style="background-color:#181870;color: #181870" value="#181870">#181870</option>
...
<option style="background-color:#6B8E18;color: #6B8E18" value="#6B8E18">#6B8E18</option>
...
<option style="background-color:#A0518D;color: #A0518D" value="#A0518D">#A0518D</option>
