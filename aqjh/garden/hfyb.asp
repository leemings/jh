...
<table width=500 border="0" align=center cellspacing="0" bordercolor="#FF0000">
        <tr bordercolor="#FFFFFF">
          <td align=center><font color=red><b>爱 情 江 湖 花 园 大 赛 风 云 榜</b></font><BR><BR></td>
        </tr>
      </table>
...
bordercolordark="#FFFFFF">
        <tr bgcolor="#DFEFFF">
          ...
          <td width=100 align=center>花赛日期</td>
          <td width=40 align=center>名次</td><td width=40 align=center>奖 品</td>
<%
rs.close
sql="select * from 花园风云榜 where 名次>0 order by 名次"
...
%>
        <tr bgcolor="" onmouseout="this.bgColor='';"onmouseover="this.bgColor='#DFEFFF';">
          ...
          <td width=100 align=center><%=rs("花赛日期")%></td>
...
<center>
<font color=red>注意：领奖前请先进行收花，否则系统将自动清理你的鲜花，以备下一届花赛的举行！</font><br><br>
<FONT color=#0000ff>&copy; 版权所有 2005-2006 </FONT><A href="http://www.7758530.com/" target=_blank><FONT color=#0000ff>快乐江湖网</FONT></A>
</body></html>