...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD colSpan=2 height=44> <DIV align=center><%if Session("aqjh_name")=name then%><A onmouseup="changeImage('button7', 'images/button7.gif');" onmousedown="" title=第一次种花必须开垦花园,如果已经种了花，就会将你的花园重新犁一遍，现在种的花都会犁掉。><IMG id=button7 height=44 alt="开 垦 花 园" src="images/button7.gif"  width=55 border=0></A><%end if%></DIV> </TD>
   </TR>
   </TBODY>
   </TABLE>
   </DIV>
...
if rs.eof then
response.redirect "../error.asp?id=68"
response.end
end if
if rs("hua")<>"" then
else
