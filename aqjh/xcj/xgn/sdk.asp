...
<TD width="244" height=15><IMG src="T2.gif" border=0></TD></TR>
  <TR><TD width="11" background=M2.gif rowSpan=3 height="1"></TD>
    <TD width="373" height=23><P align=center><SPAN lang=en>&copy;快乐江湖升点卡</P></SPAN></TD> 
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font face="宋体" color="#0000FF">升点卡在卡片屋也是买不到的，这个卡片的创立也是考虑到门派需要，还有就是为区别于加点卡，加卡卡掌门拿后有的自己使用，赚取积分，危害江湖平衡，现在实行这种卡片制度，是为让等级低的弟子使用，每个门派都根据弟子数发一定量的门派卡片，每个月评最优掌门，奖励金币，希望各位掌门能对每位弟子负责，做到更好~谢谢!^-^</font>   
</td>  
          </tr>  
          <tr>  
            <td height="1" width="441">   
...
升点卡加总积分1000点，等级大于90级不能使用，转生人同样不能使用，游侠，天网，出家的人员都不能使用！  
</td>  
          </tr>  
