...
if rs("姓名")<>yxmz then
		...
		conn.close
		set conn=nothing
		Response.Write "<script language=JavaScript>{alert('你不是站长指定的官府人员!别捣乱!');location.href = 'javascript:history.back()';}</script>"
		response.end
end if
if rs("门派")<>"官府" then
                rs.close
...
<br>
<font color="#0000FF">官府贡献奖：每天可以领取奖励，只有月积分达到10万的才可以领取！</font></font></p>
