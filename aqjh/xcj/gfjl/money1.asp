...
if rs("mvalue")<100000 then
		...
		conn.close
		set conn=nothing
		Response.Write "<script language=JavaScript>{alert('你月积分小于10万，不能领取奖励!');location.href = 'javascript:history.back()';}</script>"
		response.end
...
<body bgcolor="#CCCCCC" text="#000000" leftmargin="0" background="bk_hc3w.gif">
<div align="center">
...
<br>
<font color="#0000FF">程序开发员：每天可以领取奖励，领取的奖励是根据身份及在线时间领取的，当月积分大于20万的都计算在内！</font></font></p>
