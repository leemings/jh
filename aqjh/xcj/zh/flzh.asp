...
<div align="center"><b><font color="#FF0000">&nbsp;欢迎<font color="blue"><%=aqjh_name%></font>光临法力转换处！&nbsp;</font></b></div>
...
<%if hyrmb>1 then%>
  ...
  <div align="center"><font color="#FF0000" size="2">金卡：<%=hyrmb%>元，金卡转换法力<%=hyrmb*5000%>点<br>
