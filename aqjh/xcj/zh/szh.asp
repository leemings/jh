...
<div align="center"><b><font color="#FF0000">&nbsp;欢迎<font color="blue"><%=aqjh_name%></font>光临水属性转换处！&nbsp;</font></b></div>
        ...
        <table width="380" align="center" bordercolor="#339966" border="1">
          ...
          <tr> 
            <td valign="top" height="8" bgcolor="#000000" width="370" > 
              <div align="center">
<%if hyrmb>1 then%>
  <form method="POST" action="szhok.asp" name="af" onsubmit="bbb.disabled=1">
  <div align="center"><font color="#FF0000" size="2">金币：<%=hyrmb%>枚，金币转换水属性<%=hyrmb*200%>点<br>
