...
conn.close
set conn=nothing
says="<font color=red>【转换市场】["&aqjh_name&"]</font><font color=blue>把"&input&"元金卡转换成了"&int(input*50000)&"点轻功,于是轻功大增!</font>"
call showchat(says)
Response.Write "<script Language=Javascript>alert('"&aqjh_name&"您转换轻功:"&input*50000&"点！');location.href = 'qgzh.asp';</script>"
%>