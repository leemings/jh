...
conn.execute "update 用户 set 会员金卡=会员金卡-" & input & ",法力=法力+"& int(input*50000)&" where 姓名='"&aqjh_name&"'"
rs.close
set rs=nothing
conn.close
set conn=nothing
says="<font color=red>【转换市场】["&aqjh_name&"]</font><font color=blue>把"&input&"元金卡转换成了"&int(input*50000)&"点法力,于是法力大增!</font>"
call showchat(says)
Response.Write "<script Language=Javascript>alert('"&aqjh_name&"您转换法力:"&input*50000&"点！');location.href = 'flzh.asp';</script>"
%>