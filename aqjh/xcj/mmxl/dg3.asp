...
if rs("门派基金")<20000000 then
		Response.Write "<script language=javascript>alert('抱歉！你对门派贡献金少于2000万，不能在此练功！');history.back();</script>"
		rs.close
		set rs=nothing
		conn.close
		set conn=nothing
...
if rs("工资小点")<100 then
		Response.Write "<script language=javascript>alert('抱歉！你的工资小点少于100点！');history.back();</script>"
		rs.close
		set rs=nothing
		conn.close
		set conn=nothing
...
conn.close
set conn=nothing
says="<font color=red>【门派修炼】["&aqjh_name&"]</font><font color=blue>付了10万两白银在门派[<font color=red>"&mp&"</font>]练功处修炼第三阶段绝世武功，总积分上涨<font color=red>"&yy&"</font>点，相信经过他的不断努力，终究会成为一代高手的！</font>"
call showchat(says)
%>
<html>
<head>
...
<tr>
        ...
        <tr>
          <td height="182" valign="top"><font color="#FF0000">你在门派修炼圣地修炼第三阶段武功，经过10分钟的修炼，小有成就，基本战斗力提高30点（积分）！</font><font color="#FF00FF"><Br>
            </font><Br>
          </td>
</tr>
