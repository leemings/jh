...
says="<font color=black>【封锁】</font><font color=8800FF><font color=red>" & aqjh_name & "</font>封锁IP：<font color=red>" & lockip & "</font>(" & lockname & ")……〖原因：" & lockwhy & "〗</font><font class=t></font>"			'聊天数据
says=replace(says,"'","\'")
...
<b>［操作完成］</b> <br>
被封锁的 IP 在 <font color=red><%=Application("aqjh_iplocktime")%></font> 分钟内不能登录。你刚才的操作没有被记录在公开栏中。
<hr noshade size="1" color=009900>
<br>
