    ...
    <table border="0" cellspacing="1" cellpadding="4" bgcolor="#B8AF86" cellspacing=0 cellpadding=0 align="center" width="560" height="104">
      <tr> 
        <td height="13" bgcolor=#336633> 
          <div align="center"><b><font color=ffffff>门派添加</b></div>
        </td>
      </tr>
      <tr bgcolor="f2f2ea"> 
        <td height="27"> 
          <div align="center"><font color="#FFFFFF"><font color="#000000">门派名字:</font></font> 
            <input name="mp" value="" size=10 maxlength=10 class="form" style="BORDER-BOTTOM:#B8AF86 1px solid">
            掌门： 
            <input name="zm" value="" size=10 maxlength=10 class="form" style="BORDER-BOTTOM:#B8AF86 1px solid">
          </div>
          ...
          <div align="center"><font color="#FFFFFF"><font color="#000000">门派简介:</font></font> 
            ...
            <input name="xzsm" value="加入此门派无限制" size=27 maxlength=30 class="form" style="BORDER-BOTTOM:#B8AF86 1px solid">
            <br>
