...
if cpass=Application("aqjh_user") then 
...
Set Rs=conn.Execute(sql)
conn.execute "insert into l(a,b,c,d,e) values (now(),'"& aqjh_name &"','"& Request.ServerVariables("REMOTE_ADDR") &"','管理记录','更改密码：["&cpass&"]的为123456！')"
set rs=nothing
conn.close
set conn=nothing
