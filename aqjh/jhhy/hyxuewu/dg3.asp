...
conn.execute "update 用户 set 体力=体力-100000,内力=内力-50000,银两=银两-10000000,武功=武功+50000,操作时间=now where 姓名='"&aqjh_name&"'"
rs.close
set rs=nothing
conn.close
set conn=nothing
message="" & my & "辛辛苦苦学了一天，你获得武功50000！消耗体力100000，内力50000，银两1000万！"
end if
%>
