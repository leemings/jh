...
conn.execute "update 用户 set 体力=体力-50000,内力=内力-25000,银两=银两-5000000,武功=武功+25000,操作时间=now() where 姓名='"&aqjh_name&"'"
rs.close
set rs=nothing
conn.close
set conn=nothing
message="" & my & "辛辛苦苦学了一天，你获得武功25000！消耗体力50000，内力25000，银两500万！"
end if
%>
