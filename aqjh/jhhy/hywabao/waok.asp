...
if sj<10 then
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('请等上"&ss&"分再来挖宝吧！');location.href = 'javascript:history.go(-1)';</script>"
	Response.End
end if
randomize timer
r=int(rnd*6)+3
...
js(9)="木炭"
	...
	mess="恭喜"& aqjh_name &"挖到一[<font color=blue>"&js(myxy)&"</font>]一块，这可是个好东西呀！"
	erase js
case 2
	mess="恭喜"& aqjh_name &"挖到一包金器，到集市卖得200万银子"
	money=2000000
case 3
	mess="恭喜"& aqjh_name &"挖到一把E线神剑，变卖得到银两500万两"
	money=5000000
case 4
	mess="恭喜"& aqjh_name &"挖到一个魔法戒指，变卖得到银子100万两"
	money=1000000
case 5
	mess="倒霉的"& aqjh_name &"宝藏没找到，而且不小心踩到陷阱,体力减少50000，内力减少20000"
	tl=50000
	nl=20000
case 6
	mess="强盗又来抢劫,"& aqjh_name &"反抗遭到毒打,体力下降50000、内力下降50000"
	tl=50000
	nl=50000
case 7
	rs.close
...
conn.close
set conn=nothing
says="<font color=#ff0000>消息</font>"& aqjh_name &"在事山挖宝："&mess			'聊天数据
says=replace(says,"'","\'")
