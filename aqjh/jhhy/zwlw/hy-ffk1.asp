...
Response.Write "<script Language=Javascript>alert('提示：领取卡片是每个星期五，现在不到时间！');parent.f2.document.af.mdsx.checked=true;parent.m.location.reload();</script>"
	Response.End
end if
...
conn1.close
set conn1=nothing
says="<font size=2 color=red>【领取卡片】"&name&"</font><font size=2 color=blue>是<font color=red>"&hydj&"</font>级会员，所以去会员专区领取了<font color=red>"&lw&"</font>，会员等级越高领得卡片越多!</font>"
act="消息"
towhoway=0
towho="大家"
addwordcolor="660099"
...
<table width=401 height="227" border=3 align=center cellpadding="5" cellspacing="10" bordercolor="#6633CC">
  <tr bgcolor="#FFFFFF" align="center"> 
      <td width="367" height="252" bgcolor="#000000"><div align="center"><b>恭喜你从<font color="#FF0000">爱情江湖</font>总站那里得到了<br>
