...
conn1.open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Server.MapPath("sdlw1.asp")
...
select case r
	case 1 '金创药
		n=int(rnd*5)+6
		temp=add(wpdate,"金创药",300)
                sql="update 用户 set w1='"&temp&"' where id="&myid
		lw="金创药300个"
	case 2 '精制当归
		n=int(rnd*5)+6
		temp=add(wpdate,"精制当归",300)
                sql="update 用户 set w1='"&temp&"' where id="&myid
		lw="精制当归300个"
...
conn.close
set conn=nothing
says="【<font color=#ff0000>新人领药</font>】<font color=blue>恭喜<font color=red><b>【"& aqjh_name &"】</b></font>从站长那里得到了【<font color=red><b>"& lw &"</b></font>】，大家快去菜单的<font color=red><b>【新人领药】</b></font>处领药品啊！去晚了就没有了啊！<font color=red size=+1><b>祝各位玩家在爱情江湖玩得开心!</b></font>"			'聊天数据
says=replace(says,"'","\'")
