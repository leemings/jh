...
<title><%=Application("aqjh_chatroomname")%>新人领取卡片</title>
  ...
  <table width=401 height="227" border=3 align=center cellpadding="5" cellspacing="10" bordercolor="#6633CC" >
      <td width="367" height="252" align="center" valign="middle">输入江湖名称和密码可以领取礼品！ 
        ...
        <table width="325" height="175" align="center">
          <tr>
            <td height="169"> 
              <form method=POST action='lkok.asp' onsubmit='return(check());' name=reg>
...
江湖等级达到35级,月积分2000点方可领取！记得使用命令一区的照顾新人咯！<br>
         [<font color="#FF0000">福神卡</font>]</font><br>
         [<font color="#FF0000">健身卡</font>]<br>
        欢迎您带上您朋友一起光临[快乐江湖]</font></a>！ 
      </td>
    </table>
