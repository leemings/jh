...
set conn=nothing
if hydj<2 then
	Response.Write "<script language=JavaScript>{alert('提示：会员等级为2级以上才可以进行自动采冰！');}</script>"
	Response.End
end if
Set conn=Server.CreateObject("ADODB.CONNECTION")
Set rs=Server.CreateObject("ADODB.RecordSet")
...
href="#"
onmousedown=aba()><IMG alt=采冰 border=0 height=21 src="images/caibin.gif"
width=20></A> &nbsp; <A
href="#"
onmousedown=abe()><IMG align=middle alt=化冰 border=0 height=17
...
<div id=Layer1 style="HEIGHT: 14px; LEFT: 12px; POSITION: absolute; TOP: 402px; WIDTH: 588px; Z-INDEX: 1"><font size="-1"><b><font color="#0000FF">点击锤子开始自动采冰，点绿色方块停止自动采冰！</font></b></font></div>
</BODY>
</HTML>