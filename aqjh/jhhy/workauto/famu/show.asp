<%
Response.Write "<script Language=Javascript>parent.fs.location.href = 'famu.asp';</script>"
%><html>
<head>
<title>深山筏木</title>
  ...
  <table width="100%" border="1">
    <tr> 
      <td width="21%" height="19"> 
        <div align="center"><font size="-1">木头数：</font></div>
      </td>
      <td width="14%" height="19" id="fm1"> 
        <div align="center"><font size="-1"></font></div>
      </td>
      <td width="16%" height="19"> 
        <div align="center"><font size="-1">砍伐数:</font></div>
      </td>
...
<FORM action="famujl.asp" method=POST name="shiform" target="ig">
