...
set conn=nothing
if hydj<2 then
	Response.Write "<script language=JavaScript>{alert('提示：会员等级为2级以上才可以进行自动伐木！');}</script>"
	Response.End
end if
Set conn=Server.CreateObject("ADODB.CONNECTION")
Set rs=Server.CreateObject("ADODB.RecordSet")
...
href="#"
onclick="setTimeout('abe()',0)"> <IMG alt=停止自动伐木 border=0 class=csstext2 height=29
...
<DIV id=sjdiv style="border:1px none #000000; HEIGHT: 100px; LEFT: 250px; POSITION: absolute; TOP: 160px; VISIBILITY: hidden; WIDTH: 100px; zindex: 100;"><BR>
