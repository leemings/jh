...
if rs("银两")<wpsl*200000 then
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('提示：你钱没带够，也想要雇人采矿？想让我们替你白干？回去带钱来！！！伙计们，大家一起上去狠揍这家伙！');</script>"	
else
...
Response.Write "<script Language=Javascript>alert('提示：采到：["&wpsl&"]个，总数:["&mcsl&"]个？注意：如果你的银两不够支付"& wpsl*200000 &" 的工人工资，那你不仅得不到矿石，还会工人打掉很多体力和内力！');</script>"
response.end
end if
%>