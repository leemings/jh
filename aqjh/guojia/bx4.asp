...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>门派20大高手排行</title>
<style type="text/css">
<!--
...
rs.open "SELECT * FROM 用户 where 门派='"&id&"' order by 攻击+防御+武功 desc",conn
%>
<td width="60">
...
<td width="72">
<div align="center"><font color="#FFFFFF">武功</font></div>
</td>
<td width="75">
...
<td width="65">
<div align="center"><font color="#FFFFFF">总合计</font></div>
</td>
<td width="32">
...
<div align="center"><font color="#FFFFFF"><%=rs("武功")%></font></div>
</td>
<td width="75" height="30">
<div align="center"><font color="#FFFFFF"><%=rs("攻击")%></font></div>
</td>
<td width="66" height="30">
<div align="center"><font color="#FFFFFF"><%=rs("防御")%></font></div>
</td>
<td width="65" height="30">
<div align="center"><font color="#FFFFFF"><%=rs("攻击")+rs("防御")+rs("武功")%></font></div>
</td>
