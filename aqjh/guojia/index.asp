...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>国家机构</title>
<LINK href="../css.css" rel=stylesheet>
</head><body leftmargin="0" bgcolor="#FFFFFF" topmargin="7" background=../bg.gif>
<p align=center><font size=3>江湖国家系统</p>
...
<tr><td width=70 valign="top"></td>
    <td width="603" align="center" valign="top"> 
      <table width="100%" border="1" cellpadding="2" cellspacing="0" height="16">
        <tr align="center"> 
          <td width="79" height="11"><font color="#FF6600">国家</font></td>
          <td width="66" height="11"><font color="#FF6600">君主</font></td>
          <td width="40" height="11"><font color="#FF6600">百姓数</font></td>
          <td width="40" height="11"><font color="#FF6600">战斗力</font></td>
          <td width="80" height="11"><font color="#FF6600">国家保护</font></td>
...
loop
for xx=1 to menpai
tmprs=conn.execute("Select count(*) As 数量 from 用户 where 国家='"&jhmenpai(xx,1)&"'")
regren=tmprs("数量")
sql="update guo set c="& regren &" where a='"& jhmenpai(xx,1) &"'"
Set Rs=conn.Execute(sql)
next
rs.open "SELECT * FROM guo where a<>'无' and a<>'未知'",conn
do while not rs.bof and not rs.eof
%>
        <tr> 
          ...
          <td width="55" height="2"> 
            <div align="center"><a href="#" onClick="window.open('gj1.asp?my=<%=aqjh_name%>&amp;id=<%=rs("a")%>','zhuangti','scrollbars=no,resizable=no,width=430,height=290')">加入</a>|<a href="#" onClick="window.open('gj2.asp?my=<%=aqjh_name%>&amp;id=<%=rs("a")%>','zhuangti','scrollbars=no,resizable=no,width=430,height=290')">离开</a></div>
          </td>
        </tr>
        <%
rs.movenext
...
<p align="center"><font color="#000000" size=2>　<font color="#FF0000"> 离开国家，叛国的话,你的钱、存款将清至1000,所以请你小心!</font><br>
<font color="#0000FF">谁都想找一位好的国家君主罩着,加入国家是没错的!</font></font>
</body>
</html>