...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>国家管理</title>
<style type="text/css">
<!--
...
color="#FF6600"><b><font size="+1">国家机构</font></b></font></td>
</tr>
<tr align="center">
<td>
...
rs.open "SELECT * FROM 用户 where 国家='"&id&"' order by mvalue desc",conn
%>
<td width="31">
...
<div align="center"><a href="../guojia/gj.asp?action=<%=rs("姓名")%>"><font color="#FFFFFF"><%=rs("姓名")%></font></a></div>
</td>
