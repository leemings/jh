...
<html>
<head>
<title><%=Application("aqjh_chatroomname")%>国家等级排行</title>
<style type="text/css">
<!--
...
rs.open "SELECT * FROM 用户 where 国家='"&id&"' order by 等级 desc",conn
%>
<td width="60">
...
<td width="32">
<div align="center"><font color="#FFFFFF">叛国</font></div>
</td>
<td width="73">
<div align="center"><font color="#FFFFFF">君主操作</font></div>
</td>
<td width="73">
<div align="center"><font color="#FFFFFF">君主操作</font></div>
</td>
