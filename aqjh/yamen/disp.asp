...
%>
<HTML><HEAD><TITLE>阎王殿门口-你碰见了观音大士</TITLE>
...
<td align="center">
<input type="submit" name="submit" value="复活" style="BORDER-RIGHT: 1px solid; BORDER-TOP: 1px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid; BACKGROUND-COLOR: #e8e8d8">
...
<td>阎王说:<br>
一定要记住这个日子!!!这是你死去的日子,我可以让你重生,你一定要复仇!!!<br></td></tr>
        <TR>
