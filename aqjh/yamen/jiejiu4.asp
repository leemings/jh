...
conn.execute "update 用户 set 存款=存款-50000000,法力加=法力加-5000 where 姓名='"&name&"'"
Response.Write "<script Language=Javascript>alert('OK,你花了5000万银两和使出了5000点法力终于把自己从睡眠中救醒了!');window.close();</script>"
rs.close
set rs=nothing
conn.close
set conn=nothing%>