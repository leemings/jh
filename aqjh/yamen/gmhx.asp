          ...
          <tr>
            <td> 
              <div align="center"> 注册ID
                ...
                <br>
                密码： 
                <input type="password" name="pass" size="10" maxlength="10" class=input><br>
                新名： 
                <input type="text" name="name1" size="10" maxlength="10" class=input>
                <p>
              </div>
</td></tr><tr>
<td align="center">
