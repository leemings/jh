...
zy=Replace(zy,"&gt","")
zy=Replace(zy,"\076","")
badstr="射精|奸|去死|吃屎|你妈|你娘|日你|尻|操你|干死你|王八|逼|傻B|贱人|狗娘|婊子|表子|靠你|叉你|叉死|插你|插死|干你|干死|日死|鸡巴|睾丸|死去 |爬你达来蛋|撅你达来蛋|死你达来蛋|包皮|龟头|屄|赑|妣|肏|奶子|尻|屌|作爱|做爱|床上|抱抱|鸡八|处女|打炮|十八摸|你爷|你爸|我儿|操你|妈|逼|网管|掌门"
bad=split(badstr,"|")
...
conn.Execute "update 用户 set 地区='"&diqu&"',年龄='"&nianling&"',信箱='"&email&"',Oicq='"&oicq&"',头像='"&touxiang&"',签名='"&qianming&"' where 姓名='"&Name&"'"
conn.close
set conn=nothing
%>
<html>
...
<div align="center">
<p>&nbsp;</p>
<p><font color="#000000" size="3">您成功修改资料!</font><font color="#FF3333" size="3"><br>
</font></p>
