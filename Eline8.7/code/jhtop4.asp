...
document.writeln("<font color=00ccff><b>江湖10大富翁</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%
x=x+1
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大高手</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大恶人</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>本月10大泡手</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大色魔</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大金童</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大玉女</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大帅男</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大美女</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大杀手</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
<%x=x+1
if x=10 then exit do
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10对金婚</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("姓名")%></font><br>");
document.writeln("<font color=#ffffff>(<%=rs("配偶")%>)</font><br>");
<%
x=x+1
if x=10 then exit do
rs.movenext
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大门派</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("a")%></font><br>");
<%x=x+1
if x=10 then exit do
rs.movenext
loop
...
x=0%>
document.writeln("<font color=00ccff><b>江湖10大金库</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#ffffff><%=rs("a")%></font><br>");
<%x=x+1
if x=10 then exit do
