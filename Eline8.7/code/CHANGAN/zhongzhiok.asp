...
<center>
<%
conn.execute "update 用户 set 魅力=魅力+5,操作时间=now() where 姓名='"&sjjh_name&"'"
rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
Response.Write "<script language=JavaScript>{alert('你认认真真的种了花草，魅力上升5点！');location.href = 'zhongzhi.asp';}</script>"
Response.End
%>
</body>
</html>