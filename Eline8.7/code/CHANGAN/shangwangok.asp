...
<center>
<%
conn.execute "update 用户 set 防御=防御+1,操作时间=now() where 姓名='"&sjjh_name&"'"
rs.close
	set rs=nothing	
	conn.close
	set conn=nothing
Response.Write "<script language=JavaScript>{alert('你上网遭黑客入侵，电脑被毁坏，吸取教训，你的防御力上升1点！');location.href = 'shangwang.asp';}</script>"
Response.End
%>
</body>
</html>