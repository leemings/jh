...
sub showvisual(uservisual,visualwidth,usersex,userface,userfacewidth,userfaceheight)
 ...
 response.write "<tr>"
 response.write "<td align=center visualwidth="&visualwidth&" visualheight="&(visualwidth*226/140)&" ImagePath="""&PicPath&"""   usergender="&usersex&" baseName=""http://127.0.0.1/bbs/images/img_visual/blank.gif"" visual="""&uservisual&"""  style=behavior:url(http://127.0.0.1/bbs/inc/z_show333.htc) localpic="""&localpic&""" userface="""&userface&""" facewidth="&userfacewidth&" faceheight="&userfaceheight&"></td>"
 response.write "</tr>"
...
dim jhconn,jhsql,jhrs
  ...
  jhsql="select 性别 from 用户 where 姓名='"& sjjh_name &"'"
