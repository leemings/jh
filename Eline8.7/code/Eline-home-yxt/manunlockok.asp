...
conn.Execute sql
conn.execute "insert into l(a,b,c,d,e) values (now(),'"& sjjh_name &"','"& Request.ServerVariables("REMOTE_ADDR") &"','管理记录','解除ip封锁："&unlockip&"')"
...
says="<font color=black>【解锁】</font><font color=8800FF><font color=red>" & sjjh_name & "</font>解锁IP：<font color=red>" & unlockip & "</font>！〖原因：" & unlockwhy & "〗</font><font class=t></font>"			'聊天数据
says=replace(says,"'","\'")
