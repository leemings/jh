...
sql="SELECT 姓名,grade,times,allvalue,lasttime,lastip FROM 用户 WHERE times=1 AND CDate(lasttime)<now()-60"
...
<font color="#FF0000">【清理60天只用过１次的帐号】</font>
<br><a href="manacc.asp">返回</a></div>
<hr noshade size="1" color=009900>
<b>［注意事项］</b><br>
以下 <font color=red><%=totalrec%></font> 个帐号只用过１次，且已经超过60天<%if totalrec>0 then%>，是否清除？　<a href="manaccdel7ok.asp">是(Yes)</a>　<a href="javascript:history.go(-1)">否(No)</a>
<br>
如果其中某些帐号不想清除，请将该帐号添加到“<a href="manaccyjadd.asp">永久保留</a>”中，即可防止该帐号被删除。
<hr noshade size="1" color=009900>
<div align=center>
