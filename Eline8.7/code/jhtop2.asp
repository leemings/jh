...
x=0
%>
document.write ("<marquee scrollamount='1' scrolldelay='1' direction= 'up' width='130' height='350' id=paiheng onmouseover=paiheng.stop() onmouseout=paiheng.start()><div align=center>");
document.writeln("<font color=blue><b>江湖10大富翁</b></font><br>");
<%do while not rs.eof%>
document.writeln("<font color=#333333><%=rs("姓名")%></font><br>");
<%
x=x+1
...
<%do while not rs.eof%>
document.writeln("<font color=#333333><%=rs("姓名")%></font><br>");
document.writeln("<font color=#333333>(<%=rs("配偶")%>)</font><br>");
<%
x=x+1
if x=10 then exit do
rs.movenext
