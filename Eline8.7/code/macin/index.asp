...
if trim(rs("职业"))<>"郎中" then
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('提示：您的职业不是郎中，所以您不能进去打麻将！！');window.close();</script>"
	response.end
end if
rs.close
set rs=nothing	
...
<title>麻将♀wWw.51eline.com♀</title>
</head>
  ...
  <table border="0" width="80%" cellspacing="0" cellpadding="0" height="163" background="../picc/bg.jpg">
    ...
    <tr>
      ...
      <td width="88%" align="center" height="26"><!--webbot bot="ImageMap"
        startspan
        text=" (16,0) (94, 22) {三国麻将} {标楷体} 12 P #ffff00 CT 0  "
        border="0" src="../../../38.gif" u-originalsrc="../../../38.gif"
        u-overlaysrc="file:///C:/Documents and Settings/Administrator/桌面/DoM/open/macin/index.asp_txt_38.gif" --><img border="0" src="file:///C:/Documents%20and%20Settings/Administrator/桌面/DoM/open/macin/index.asp_txt_38_cmp.gif"><!--webbot
    ...
    <tr>
      <td width="88%" height="83" valign="top">
        <table border="0" width="100%">
          ...
          <tr>
            <td width="100%" align="center">欢迎来到三国麻将馆记住喔赢了可以拿到20万大银喔</td>
          </tr>
