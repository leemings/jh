...
if rs("体力")<-100 then
	...
	conn.execute "insert into l(b,a,c,e,d) values ('" & sjjh_name & "',now(),'僵尸','因勇打嫖客所牺牲','人命')"
	rf="<img src='img/kl.gif'>太不幸了，["&sjjh_name&"]任务没有完成：人贩子(ren fanzi)：“你也想杀了我？嘿嘿~………"
	call boot(sjjh_name,"人贩，操作者：人贩，抓我呀找死！")
else
dim js(10)
js(0) ="骨头"
js(1) ="蓝宝石"
...
rf="任务完成：人贩子(ren fanzi)：“你居然杀了我？难道你不想知道哪些孩子的下落了么？官府奖励<img src='img/251.gif'>"&tempjs*55&"两！道德提升200点，而后，"&sjjh_name&"得到了[<b><font color=red>"&js(myxy)&"</font></b>]1个……"
