...
tempjs=int(abs(clng(Application("sjjh_kp"))))
if tempjs<>tl then
...
conn.execute "update 用户 set w5='"&zstemp&"' where 姓名='" & sjjh_name &"'"
kl="平时的时候看["&sjjh_name&"]作事慢慢腾腾的，没想到有好处的事他最快。卡片[<b><font color=red>"&js(myxy)&"</font></b>]1张，被"& sjjh_name &"检走……"
rs.close
set rs=nothing
conn.close
set conn=nothing
