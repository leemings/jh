...
fn1=int(abs(fn1))
if fn1<2 or fn1>100 then
	Response.Write "<script language=JavaScript>{alert('提示：对赌金币应大于2，小于100！');}</script>"
	Response.End
end if
...
duidu="<form method=POST target=d name=duidu"&regjm&" action=duidu.asp?name="&urlencoding(sjjh_name)&"&fn1="&fn1&"&toname="&urlencoding(to1)&"&m1="&m1&"&m2="&m2&"&m3="&m3&"><font color=green>【对赌】<font color=" & saycolor & ">[##]向{%%}提出对赌请邀请，赌注为："&fn1&"金币，<input type=submit onClick=javascript:duidu"&regjm&".disabled=1;this.document.duidu"&regjm&".submit() name=duidu"&regjm&" value=赌金币></form>"
end function
