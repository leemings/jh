...
duidu2="<form method=POST target=d name=duidu2"&regjm&" action=duidu2.asp?name="&urlencoding(sjjh_name)&"&fn1="&fn1&"&toname="&urlencoding(to1)&"&m1="&m1&"&m2="&m2&"&m3="&m3&"><font color=green>【对赌法力】<font color=" & saycolor & ">[##]向{%%}提出对赌请邀请，赌注为："&fn1&"点轻功，<input type=submit onClick=javascript:duidu2"&regjm&".disabled=1;this.document.duidu2"&regjm&".submit() name=duidu2"&regjm&" value=赌轻功></form>"
end function
