...
rs.open "select 门派,性别,配偶,道德,魅力,银两 FROM 用户 WHERE 姓名='" & sjjh_name &"'",conn,2,2
...
qiuhun="<bgsound src=wav/mg.WAV loop=1>[##]向{%%}求婚：<img src='img/29.gif'>"&fn1&"<input type=button value='我愿意' onClick=javascript:tongyi"&regjm+1&".disabled=1;tongyi"&regjm&".disabled=1;window.open('jiehun.asp?name=" & sjjh_name &"&yn=1&to1="&to1&"','d') name=tongyi"&regjm&"><input type=button value='不愿意' onClick=javascript:;tongyi"&regjm+1&".disabled=1;tongyi"&regjm&".disabled=1;window.open('jiehun.asp?name=" & sjjh_name &"&yn=0&to1="&to1&"','d') name=tongyi"&regjm+1&">"
end function
%>
