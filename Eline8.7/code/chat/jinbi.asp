...
if Application("sjjh_jinbi")=0 then
	Response.Write "<script Language=Javascript>alert('提示：你小子来晚了，金币没有了...');</script>"
	response.end
end if
...
conn.execute "update 用户 set 金币=金币+"& temp &" where 姓名='" & sjjh_name &"'"
jinbi="今天真是走运，出门都有金币砸到我的脑袋上，呵。。。因此：["&name&"]得到:<img src='img/jinbi.gif'>"&temp&"个!"
conn.close
set conn=nothing
