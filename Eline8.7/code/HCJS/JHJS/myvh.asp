...
%>
<HTML><HEAD><TITLE><%=Application("sjjh_chatroomname")%>--交通工具设置</TITLE>
...
<DIV align=center>
<p align="center">[ <font color="#FF3300" size=4><%=Application("sjjh_chatroomname")%>--我的交通工具</font> ]</p> 
<font color="#FF00FF" size=4><a href="vehicle.asp" target="_self"  title="去购买各式各样的交通工具">点击这儿返回[交通工具专卖店]页面</a></font><br><br> 
...
%> 
  ...
  <%else%> 
    <select>
  <option value=true  selected >进入聊天室时</option><option value=false>退出聊天室时</option>
  <%end if%>
    </select>
...
如进入时：##开着刚买不久的$$，来到了<%=Application("sjjh_chatroomname")%>，见到各位大虾，拱手曰：“众位大虾，小生有礼了”<br>
