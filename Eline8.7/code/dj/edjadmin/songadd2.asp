...
<form method="POST" action="Songadd3.asp">
          <tr>
            <td width="100%" align="center" bgcolor="#FFCB7D" colspan="2">舞曲批量添加
            第一步(设定)</td>
          </tr>
          <tr>
            <td width="28%" align="right">添加多少首：</td>
            <td width="72%">
          ...
          <tr>
            <td width="28%" align="right">选择统一分类：</td>
            <td width="72%">
...
%>
          ...
          <tr>
            <td width="28%" align="right">填写统一名称：</td>
            <td width="72%">
            <input type="text" name="MusicName" size="26"></td>
          </tr>
          <tr>
            <td width="28%" align="right">填写统一制作人：</td>
            <td width="72%">
            <input type="text" name="DJ Anjo" size="18"></td>
          </tr>
          <tr>
            <td width="28%" align="right">填写统一链接地址：</td>
            <td width="72%">
            <input type="text" name="LF_Path" size="52"></td>
          </tr>
          <tr>
            <td width="27%" align="right">选择统一播放方式：<br>
          ...
          <tr>
            ...
            <input type="hidden" value="add" name="act">
              <input type="submit" value=" 进 入 下 一 步" name="cmdok"></td>
          </tr>
          </form>
        </table>
        </td>
