...
欢迎您：<font color=#ff0000><%=membername%></font> <br>您可以视听所有舞曲
...
<center>
                ...
                <input type="button" value="退出登陆" name="exit" style="border-style:solid; border-width:1; height:16; Width=55; font-size:9pt; background-color:#CCCC00" onclick=window.open("../exit.asp","_self")><br><br>
</center>
</td>
</tr>
