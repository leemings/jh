...
function stopTrack() { 
	...
	else { alert("²¥·ÅÒÑÍ£Ö¹!"); return false;}
	songPlaying = false; 
	updateTrack(); 
}
...
function updateTrack() { 
	...
	switch (showTitle) {
		...
		switch (showTitle) {
		case 0 :
			window.status = ('Ayxz Player [stopped]'); return true;
			break;
		case 1 :
			document.form1.stitle.value = "Ayxz Player [stopped]";
			break;
		case 2 :
			window.status = ('Ayxz Player [stopped]'); return true;
			break;
