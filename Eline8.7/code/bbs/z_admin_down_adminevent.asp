...
if not master or session("flag")="" then
	...
	<table border="0" width="95%" cellspacing="0" cellpadding="0" align=center>
		...
		<tr>
			<td width="100%"><font color=<%=forum_body(8)%>>管理员管理日志</font>　　<a href="z_admin_down_downevent.asp">付费用户下载日志</a>　　<a href="z_admin_down_userevent.asp">付费用户管理日志</a></td>
		</tr>
		<tr>
			<td width="100%" align=center><font color="#FF0000">管理员管理日志</font></td>
		<tr>
		<tr>
					...
					if rs.eof and rs.bof then
						...
						do while not rs.eof and i<MaxPerPage
							...
							<tr>
								...
								<td width="55%" class=forumrow>&nbsp;<%=rs("event")%></td>
