...
<tr> 
<td width="40%" class="forumrow"><B>Dispbbs帖子底部广告代码</B></font></td>
<td width="60%" class="forumrow"> 

<textarea name="Dispbbs_form_ads" cols="50" rows="3"><%=Dispbbs_plus_ads%></textarea>
</td>
</tr>
<tr> 
...
dim dispbbs_save_ads
dispbbs_save_ads=request.form("dispbbs_form_ads")
if request("checkall")="1" then
sql = "update config set Forum_ads='"&CheckStr(Forum_ads)&"',dispbbs_ad='"&dispbbs_save_ads&"'"
conn.execute(sql)
else
if request("skinid")<>"" then
