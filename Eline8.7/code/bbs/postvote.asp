...
sub main()
	...
	if rs.eof and rs.bof then
		...
		if not(vrs.eof and vrs.bof) then
			...
			conn.execute("update [user] set userwealth=userwealth+"&forum_user(40)&",userep=userep+"&forum_user(41)&",usercp=usercp+"&forum_user(42)&" where userid="&userid)
		end if
	end if
	rs.close
	set rs=nothing
