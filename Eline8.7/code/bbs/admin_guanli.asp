...
menu(1,6)="<a href=announcements.asp?boardid=0&action=addann target=_blank>发布论坛公告</a> | <a href=announcements.asp?action=editann&boardid=0 target=_blank>管理</a>"
...
menu(6,5)="<a href=z_admin_connsql.asp target=main>数据库管理</a>"
...
menu(8,0)="插件管理中心"
menu(8,1)="<a href=z_admin_plus.asp target=main>插件后台管理</a>"
menu(8,2)="<a href=z_admin_plus.asp?action=tj target=main>插件访问统计</a>"
menu(8,3)="<a href=z_admin_jifen.asp target=main>自助工资管理</a>"
menu(8,4)="<a href=z_admin_vip.asp target=main>VIP会员管理</a>"
menu(8,5)="<a href=z_admin_adv.asp target=main>广告管理</a>"
menu(8,6)="<a href=z_admin_visual.asp target=main>个人形象管理</a>"
menu(8,7)="<a href=z_admin_down_manage.asp target=main>下载中心管理</a>"
...
<table cellpadding=0 cellspacing=0 width=158 align=center>
  <tr>
    <td height=25 class=menu_title onmouseover=this.className='menu_title2'; onmouseout=this.className='menu_title'; background=skin/default/title_bg_quit.gif  >
	  <span><a href="admin_guanli.asp" target=_top><b>管理首页</b></a> | <a href=admin_logout.asp target=_top><b>退出</b></a></span>
    </td>
  </tr>
</table>
&nbsp;
...
<%
if not master or session("flag")="" then
	Errmsg=Errmsg+"<br>"+"<li>本页面为管理员专用，请<a href=admin_guanli.asp target=_top>登陆</a>后进入。"
	call dvbbs_error()
else
