...
<%if not master or session("flag")="" then
	...
	<table width="95%" border="0" cellpadding="3" cellspacing="1" align=center class=tableborder>
		...
		<tr>
			...
			<td width="85%" height="30" class=forumrow><input type="text" name="txtfilename" size="103" class="smallinput" maxlength="255">&nbsp;<font color=<%=forum_body(8)%>><B>**</b></font>&nbsp;<font color=red>是否防盗</font><input type="checkbox" name="localdown" value="on"></td>
		</tr>
		<tr>
