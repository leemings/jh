...
if not founduser then
	founderr=true
	Errmsg=Errmsg+"<br>"+"<li>请<a href=login.asp>登录</a>后进行相关操作。"
end if
if founderr then
	call nav()
	call head_var(2,0,"","")
...
sub announceinfo()
	...
	if not(rs.bof and rs.eof) then
		topic_1=rs(0)
		topic="报告有问题的帖子"
		body=body & "您可以到http://"&request.servervariables("server_name")&replace(request.servervariables("script_name"),"report.asp","")&"dispbbs.asp?boardid="&boardid&"&id="&Announceid&"这里浏览这个帖子"
	else
		foundErr = true
...
<table cellpadding=3 cellspacing=1 align=center class=tableborder1>
	...
	<tr>
    <td class=tablebody1><b>消息内容：</b><br>垃圾帖、广告帖、非法帖等。。。
非必要情况下不要使用这项功能！</td>
    <td  class=tablebody1><textarea name="content" cols="55" rows="6">管理员，您好，由于如下原因，我向你报告这有问题的帖子：</textarea></td>
    </tr><tr>
