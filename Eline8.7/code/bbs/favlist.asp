...
if not founduser then
	Errmsg=Errmsg+"<br>"+"<li>您还没有<a href=login.asp>登录论坛</a>，不能查看收藏。如果您还没有<a href=reg.asp>注册</a>，请先<a href=reg.asp>注册</a>！"
	Founderr=true
end if
call nav()
if Founderr then
...
if rs.eof and rs.bof then
	Errmsg=Errmsg+"<br>"+"<li>您的收藏夹还没有收藏，您可以收藏论坛指定帖子，当收藏中有数据后，本信息将自动删除！"
	founderr=true
	exit sub
else
%>
