...
if not master or session("flag")="" then
	...
	if not isempty(request("selAnnounce")) then
		...
		sql="delete from userevent where id in ("&idlist&")"
	...
	<table border="0" width="95%" cellspacing="0" cellpadding="0" align=center>
		...
		<tr>
			<td width="100%"><a href="z_admin_down_adminevent.asp">管理员管理日志</a>　　<a href="z_admin_down_downevent.asp">付费用户下载日志</a>　　<font color=<%=forum_body(8)%>>付费用户管理日志</font></td>
		</tr>
		<tr>
			<td width="100%" align=center><font color="#FF0000">付费用户管理日志</font></td>
		<tr>
		<tr>
			<td width="100%" align=center>
				<table border="0" cellspacing="1" cellpadding="3" width="100%" class=tableborder>
					...
					<%dim n,totalput
					sql="select * from userevent order by id desc"
					...
					if rs.eof and rs.bof then
						...
						do while not rs.eof and i<MaxPerPage
							...
							<tr>
								...
								<td width="55%" class=forumrow>&nbsp;<%=rs("userevent")&" | 对象："&rs("username")&" | 操作人："&rs("conuser")%></td>
