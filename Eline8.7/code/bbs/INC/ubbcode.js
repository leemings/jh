...
var error_no_money       = "您必须输入数值，如：1000";
...
var text_enter_usemoney    = "请输入数值，如：50 (即只有用户支付了50元现金才能浏览该内容!)";
var text_enter_usemoneyset    = "请输入数值0或1，(如果有人购买是否使用短信通知我，0-否 1-是)";
var error_no_usemoney       = "您必须输入50以下的数值，如：50";
var error_no_usemoneyset       = "您必须输入0或1";
var text_enter_group    = "请输入门派，如：无门无派 (即只有门派为无门无派的用户才能浏览该内容!)";
var error_no_group       = "您必须输入门派名称，如：无门无派";
var text_enter_userage    = "请输入数值，如：30 (即限制注册时间在30天以下的用户不能浏览该内容!)";
var error_no_userage       = "您必须输入数值，如：30";
var text_enter_sex    = "请输入数值，如：1 (即只有男性用户才能浏览该内容!)";
var error_no_sex       = "您必须输入数值0或1";
var text_enter_spec    = "请输入用户，如：老庙黄金|小马哥 (即只有老庙黄金和小马哥才能浏览该内容!)";
var error_no_spec       = "您必须输入用户，如：老庙黄金|小马哥";
var text_enter_sec    = "请输入用户组ID，如：1|2|3 (即只有管理员、超级版主和版主才能浏览该内容!)";
var error_no_sec       = "您必须输入用户，如：1|2|3";
var text_enter_timel    = "请输入数值，如：2 (即2天后用户才能浏览该内容!)";
var error_no_timel       = "您必须输入数值，如：2";
var text_enter_timex    = "请输入数值，如：2 (即限制用户2天后不能浏览该内容!)";
var error_no_timex       = "您必须输入数值，如：2";
...
function usergroup() {
	var FoundErrors = '';
	var enterpost  =prompt(text_enter_group,"无门无派");
	if (!enterpost) {
		FoundErrors += "\n" + error_no_group;
	}
	if (FoundErrors) {
...
function spec() {
	var FoundErrors = '';
	var enterpost  =prompt(text_enter_spec,"老庙黄金|小马哥");
	if (!enterpost) {
		FoundErrors += "\n" + error_no_spec;
	}
	if (FoundErrors) {
