...
%>
     <div align="center">
      ...
      <table border="1" width="90%" cellspacing="0" cellpadding="0" class="TableLine" bordercolorlight="#CC0066">
        <tr>
          <td width="100%" height="20" bgcolor="#CC0066" align=center><font color="white"><b>三 级 分 类 管 理</b></font></td>
        </tr>
        <tr>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                   <form method="POST" action="SClassSave.asp?act=add&Classid=<%=rs("Classid")%>" align="center">
                    <tr>
                      ...
                      <td width="80%"><b>↓请先进入二级分类列表,然后选择三级分类进行管理</b></td>
                      <td width="0%"><b></td>
                    </tr>
                   </form>
                  </table>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                   <form method="POST" action="SClassSave.asp?act=add&Classid=<%=rs("Classid")%>" align="center">
                    <tr>
                      ...
                      <td width="80%"><a href=3-2sort.asp?id=<%=rs("Classid")%>><---进入此类所属的二级分类-->进行三级分类管理</a></td>
                      <td width="0%"></td>
                    </tr>
                   </form>
                  </table>
