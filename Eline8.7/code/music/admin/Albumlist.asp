...
%>
<head>
<title>"<%=rs("Nclass")%>"专辑列表::::::{天籁音乐网 }::::::http://WWW.119MUSIC.COM/</title>
</head>
<!--#include file="Top.asp"-->
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td height="20" bgcolor="#F79618">　<a href="index.asp"><font color="#000000">天籁音乐网 
      &gt;</font></a> <font color="#000000"><a href="Artlist.asp?Name=Yxmusic&ID=<%=rs("SClassid")%>"><%=rs("SClass")%> &gt;</a> <%=rs("Nclass")%> &gt; 专辑列表 
