...
<table width="766" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#E7F3FF">
  <tr bgcolor="#66CCFF"> 
    <td width="587" height="20">　<a href="index.asp"><font color="#000000">一线视听</font></a> 
      <font color="#000000"> 劲暴专辑</font></td>
    <td width="179">　</td>
  </tr>
  <tr > 
...
%>
              <tr> 
                ...
                <td width="48%">专辑名称：<a href="MusicList.asp?AlbumID=<%=rs("Specialid")%>">[<%=rs("name")%>]</a><br>
                  <br>
                  发行日期：<%=rs("Times")%></td>
                <td width="28%">点击次数：<font color="#FF0000"><%=rs("hits")%></font><br>
                  <br>
