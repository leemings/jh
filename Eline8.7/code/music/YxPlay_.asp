...
<body bgcolor="#000000" leftmargin="0" topmargin="0" onLoad="drop(300)">
<%
if request("id")="" then
...
<BODY scroll=no bgColor=#FF9900 leftMargin=0  topMargin=0 oncontextmenu="return false" ondragstart="return false" onselectstart="return false"> 
