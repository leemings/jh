...
Conn_String = "DRIVER={Microsoft Access Driver (*.mdb)};DBQ=" & Server.MapPath("e_count.mdb")
...
document.write('当前<font color=#cc0000><strong>Flash</strong></font>频道在线{<font color=#cc0000><strong><%=count%></strong></font>}人');
