...
if(confirm('您确定要删除吗？'))
 {
 location.href="del_flash_class.asp?classid="+classid+""
 }
}
</script>
</head>
...
<table width="500" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#F7F7F7" align="center"><%
   const MaxPerPage=20
   dim totalPut   
   dim CurrentPage
   dim TotalPages
...
rs.open sql,conn,1,1
  if rs.eof and rs.bof then
       response.write "<p align=center class=font>暂无动画类别</p>"
   else
      ...
      if (currentpage-1)*MaxPerPage>totalput then
       ...
       if currentPage=1 then
            ...
            showContent
            showpage totalput,MaxPerPage,"manage_flash_class.asp"
       else
          if (currentPage-1)*MaxPerPage<totalPut then
...
%>
      <%do while not rs.eof%>
<tr bgcolor="#FFFFFF">
    <td><%=rs("classid")%>.<%=rs("classname")%></a></td>
    <td width="60" align="center" bgcolor="#F7F7F7"><a href="edit_flash_class.asp?classid=<%=rs("classid")%>&action=edit">编辑</a></td>
    <td width="60" align="center" bgcolor="#F7F7F7"><a href="javascript:del(<%=rs("classid")%>)">删除</a></td>
  </tr>
<% i=i+1
...
%>
      ...
      <table width="500" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td height="21" bgcolor="#CCCCCC" align="center">
<%
end sub 
function showpage(totalnumber,maxperpage,filename)
  ...
  if n-currentpage<1 then
   ...
   response.write "&nbsp;页次：</font><b><font color=red>"&CurrentPage&"</font>/"&n&"</b>页</font> "
    response.write "&nbsp;共<b>"&totalnumber&"</b>个类别 <b>"&maxperpage&"</b>个类别/页"
end function
%>
    </td>
  </tr>
