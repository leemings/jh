...
Public Function AdminMsgOut(Msg,href,mode)
	...
	elseif mode=3 then
		...
		response.write"<tr><td width=""50%"">杭州市上城区人才交流服务中心 后台信息管理系统</td><td width=""50%"" align=""right"">程序设计：思达科技&nbsp;&nbsp; </td>"
...
'		Response.Write("[<A HREF=" & action & "?" & temp & "Page=" & pagecount & ">最后一页</A>]" & vbCrLf)			
	...
	'Response.Write(" 第" & "<INPUT TYEP=TEXT NAME=page SIZE=2 Maxlength=5 VALUE=" & page & ">" & "页"  & vbCrLf & "<INPUT type=submit style=""font-size: 7pt"" value=GO id=submit1 name=submit1>")
