...
If not(Rs.Bof OR Rs.Eof) Then
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('提示：["&sjjh_name&"你在江湖上申请过离婚了！！');location.href = 'lihun.asp';</script>"	
	response.end
end if
rs.close
...
conn.Execute "INSERT INTO h (a,b,c,d,e,f) VALUES('"&sjjh_name&"','"&name&"','离婚',"&money&",now(),'"&mess&"')"
Response.Write "<script Language=Javascript>alert('提示："& sjjh_name &"你的离婚登记成功！！');location.href = 'lihun.asp';</script>"	
response.end
%>
