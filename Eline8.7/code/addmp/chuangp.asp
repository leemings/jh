...
<div align="center">
  ...
  <table border="0" width="80%" cellspacing="0" cellpadding="0" height="225" background="../picc/bg.jpg">
    ...
    <tr>
      ...
      <td width="88%" align="center" height="26"><img border="0" src="22.gif"></td>
      <td width="4%" background="../picc/k3.gif" height="189" rowspan="4">　</td>
    </tr>
    <tr>
      <td width="88%" height="70" align="center"><img border="0" src="king3.jpg" width="487" height="263"></td>
    </tr>
    <tr>
      <td width="88%" height="145" valign="top">
        <table border="0" width="100%">
          ...
          <tr>
              <td width="100%" align="center"><font color="#FFFFFF">自创门派后不得做任何官职请三思</font></td>
          </tr>

          <tr>
            <td width="100%" align="center">创派条件如下</td>
          </tr>
          <tr>
            <td width="100%">        
              ...
              <table border="0" width="100%">
                <tr>
                  <td width="100%" align="center">等级:30→内力:2000000→体力:2000000→攻击:10000→魅力:5000→银两50000000
                    <p>最重要的是必须为本江湖拉15人才可以创派</p>
                  </td>
                </tr>
                <tr>
                  <td width="100%" align="center">符合条件的请<a href="cpsq.asp"><font color="#00FF00">进来</font></a></td>
                </tr>
                <tr>
                  <td width="100%">
                    <table border="0" width="100%">
                      ...
                      <tr>
                        <td width="100%" align="center"><a href=# onclick="window.close()"><font color="#00FF00">关闭</font></a></td>
                      </tr>
                ...
                <div align="center"><font color="#CC0000">门派创立后.弟子的银两等问题一律自付.一个月内弟子数不足15者：删！</font></div></td>
          </tr>
         <td><hr>
