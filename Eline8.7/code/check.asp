...
if myid="" then
	Response.Write "<script Language=Javascript>alert('开什么玩笑啊？连江湖ID都不报？！');location.href = 'javascript:history.go(-1)';</script>"
	response.end
end if
...
if rs.eof or rs.bof then
	...
	conn.close
	set conn=nothing
	Response.Write "<script Language=Javascript>alert('您输入的名字我们找不到!\n请查看您的ID、姓名、密码！');location.href = 'javascript:history.go(-1)';</script>"
	response.end
end if
id=rs("id")
...
'badword="我塞,黑客,嘿客,老师,射精,奸,去死,老子,弟,吃屎,你妈,你娘,日你,鬼,色,尻,操你,色狼,干死你,王八,逼,贱人,狗娘,婊子,表子,靠你,叉你,叉死,垃圾,混蛋,浑蛋,插你,插死,干你,干死,日死,鸡巴,睾丸,死去,处女,处男,按摸,江湖,中国,爬你达来蛋,撅你达来蛋,死你达来蛋,包皮,龟头,猪,狗,猫,屄,赑,妣,肏,奶子,尻,屌,作爱,做爱,床上,抱抱,鸡八,打炮,十八摸,你爷,你奶奶,你老爸,你老妈,我做你,你爸,我儿,操你,逼,网管,掌门,我干,我操,你母,我搞,去死,法伦,法伦功,锦涛,腚,猪,踢,抓,爹,爸,我,爷,父,妈,娘,奶,鞋,妓,娼,摸,阴,蒂,奸,死,屎,尻,操,逼,贱,狗,婊,表,靠,叉,插,干,龟,头,屄,赑,妣,肏,尻,屌,床,抱,蛋,炮,·,主席,我靠,泽民,洪志,六扇门,官府,公安,警察,检察,法院,政府,司法,祖"
badword="党,法轮功"
bad=split(badword,",")
