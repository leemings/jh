...
x=0
%>
document.write ("<marquee scrollamount='1' scrolldelay='1' direction= 'up' width='130' height='190' id=paiheng onmouseover=paiheng.stop() onmouseout=paiheng.start()><div align=center>");
