...
sqlstr="select * from 用户 where 姓名='"&sjjh_name&"'" &" and 银两>="&horsecalc
rs.open sqlstr,conn
...
i=i+1
loop
conn.Execute "update 用户 set 银两=银两+"&horse(horsewin)*10-horsecalc&" where 姓名='"&sjjh_name&"'"
conn.close
set conn=nothing
erase horsepoint
...
Response.Write msg
%>
<html><title><%=Application("sjjh_chatroomname")%>赛马程序</title>
<body bgcolor="#CCCCCC">
<br>
</html>
